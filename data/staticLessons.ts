...
export const STATIC_LESSONS: Record<number, VocabularyItem[]> = {
 ...
 5: [
  ...
  36: [
    { id: 'L36-W1', category: 'Verbs', grammarType: 'Group II', kanji: '見えます', kana: 'みえます', romaji: 'miemasu', meaning: '看得见', conjugations: { dictionary: '見える', masu: 'みえます', te: '見えて', nai: '見えない', ta: '見えた' }, sentences: [{ ja: '遠くの山が見えます。', zh: '看得见远处的山。' }] },
    { id: 'L36-W2', category: 'Verbs', grammarType: 'Group II', kanji: '聞こえます', kana: 'きこえます', romaji: 'kikoemasu', meaning: '听得见', conjugations: { dictionary: '聞こえる', masu: 'きこえます', te: '聞こえて', nai: '聞こえない', ta: '聞こえた' }, sentences: [{ ja: '隣の部屋から音が聞こえます。', zh: '从隔壁房间听得到声音。' }] },
    { id: 'L36-W3', category: 'Verbs', grammarType: 'Group I', kanji: '届きます', kana: 'とどきます', romaji: 'todokimasu', meaning: '送到，够得着', conjugations: { dictionary: '届く', masu: 'とどきます', te: '届いて', nai: '届かない', ta: '届いた' }, sentences: [{ ja: '荷物は明日届きます。', zh: '行李明天会送到。' }] },
    { id: 'L36-W4', category: 'Verbs', grammarType: 'Group II', kanji: '出ます', kana: 'でます', romaji: 'demasu', meaning: '参加，出席；出来', conjugations: { dictionary: '出る', masu: 'でます', te: '出て', nai: '出ない', ta: '出た' }, sentences: [{ ja: '試合に出ます。', zh: '参加比赛。' }] },
    { id: 'L36-W5', category: 'Verbs', grammarType: 'Group I', kanji: '打ちます', kana: 'うちます', romaji: 'uchimasu', meaning: '打，敲；输入', conjugations: { dictionary: '打つ', masu: 'うちます', te: '打って', nai: '打たない', ta: '打った' }, sentences: [{ ja: 'ワープロで字を打ちます。', zh: '用文字处理机打字。' }] },
    { id: 'L36-W6', category: 'Verbs', grammarType: 'Irregular', kanji: '貯金します', kana: 'ちょきんします', romaji: 'chokin shimasu', meaning: '存钱', conjugations: { dictionary: '貯金する', masu: 'ちょきんします', te: '貯金して', nai: '貯金しない', ta: '貯金した' }, sentences: [{ ja: '旅行のために貯金しています。', zh: '为了旅行正在存钱。' }] },
    { id: 'L36-W7', category: 'Verbs', grammarType: 'Group I', kanji: '太ります', kana: 'ふとります', romaji: 'futorimasu', meaning: '胖，发胖', conjugations: { dictionary: '太る', masu: 'ふとります', te: '太って', nai: '太らない', ta: '太った' }, sentences: [{ ja: '甘い物を食べ過ぎると、太ります。', zh: '甜食吃太多会发胖。' }] },
    { id: 'L36-W8', category: 'Verbs', grammarType: 'Group II', kanji: 'やせます', kana: 'やせます', romaji: 'yasemasu', meaning: '瘦', conjugations: { dictionary: 'やせる', masu: 'やせます', te: 'やせて', nai: 'やせない', ta: 'やせた' }, sentences: [{ ja: '運動して、少しやせました。', zh: '运动后瘦了一点。' }] },
    { id: 'L36-W9', category: 'Verbs', grammarType: 'Group II', kanji: '過ぎます', kana: 'すぎます', romaji: 'sugimasu', meaning: '过；过度', conjugations: { dictionary: '過ぎる', masu: 'すぎます', te: '過ぎて', nai: '過ぎない', ta: '過ぎた' }, sentences: [{ ja: '11時を過ぎました。', zh: '过了11点。' }] },
    { id: 'L36-W10', category: 'Verbs', grammarType: 'Group II', kanji: '慣れます', kana: 'なれます', romaji: 'naremasu', meaning: '习惯', conjugations: { dictionary: '慣れる', masu: 'なれます', te: '慣れて', nai: '慣れない', ta: '慣れた' }, sentences: [{ ja: '日本の生活に慣れました。', zh: '习惯了日本的生活。' }] },
    { id: 'L36-W11', category: 'Adjectives', grammarType: 'i-adj', kanji: '硬い', kana: 'かたい', romaji: 'katai', meaning: '硬', sentences: [{ ja: 'このパンは硬いです。', zh: '这个面包很硬。' }] },
    { id: 'L36-W12', category: 'Adjectives', grammarType: 'i-adj', kanji: '柔らかい', kana: 'やわらかい', romaji: 'yawarakai', meaning: '软，柔软', sentences: [{ ja: 'この肉は柔らかいです。', zh: '这块肉很嫩。' }] },
    { id: 'L36-W13', category: 'Nouns', kanji: '電子辞書', kana: 'でんしじしょ', romaji: 'denshi jisho', meaning: '电子词典', sentences: [{ ja: '電子辞書を使っています。', zh: '正在用电子词典。' }] },
    { id: 'L36-W14', category: 'Nouns', kanji: '携帯電話', kana: 'けいたいでんわ', romaji: 'keitai denwa', meaning: '手机', sentences: [{ ja: '携帯電話を忘れました。', zh: '忘带手机了。' }] },
    { id: 'L36-W15', category: 'Nouns', kanji: '工場', kana: 'こうじょう', romaji: 'koujou', meaning: '工厂', sentences: [{ ja: 'この工場で車を作っています。', zh: '这家工厂在生产汽车。' }] },
    { id: 'L36-W16', category: 'Nouns', kanji: '健康', kana: 'けんこう', romaji: 'kenkou', meaning: '健康', sentences: [{ ja: '健康のために毎日歩きます。', zh: '为了健康每天走路。' }] },
    { id: 'L36-W17', category: 'Nouns', kanji: '剣道', kana: 'けんどう', romaji: 'kendou', meaning: '剑道', sentences: [{ ja: '剣道を習っています。', zh: '正在学习剑道。' }] },
    { id: 'L36-W18', category: 'Adverbs', kanji: 'できるだけ', kana: 'できるだけ', romaji: 'dekiru dake', meaning: '尽量', sentences: [{ ja: 'できるだけ日本語で話すようにしています。', zh: '尽量用日语说话。' }] },
    { id: 'L36-W19', category: 'Adverbs', kanji: '必ず', kana: 'かならず', romaji: 'kanarazu', meaning: '一定，必定', sentences: [{ ja: '寝る前に必ず歯を磨きます。', zh: '睡前一定刷牙。' }] },
    { id: 'L36-W20', category: 'Adverbs', kanji: '絶対に', kana: 'ぜったいに', romaji: 'zettai ni', meaning: '绝对', sentences: [{ ja: '絶対に忘れないでください。', zh: '请绝对不要忘记。' }] },
    { id: 'L36-W21', category: 'Adverbs', kanji: '上手に', kana: 'じょうずに', romaji: 'jouzu ni', meaning: '熟练地，擅长地', sentences: [{ ja: '上手に泳げるようになりました。', zh: '变得会熟练游泳了。' }] },
    { id: 'L36-W22', category: 'Expressions', kanji: 'このごろ', kana: 'このごろ', romaji: 'konogoro', meaning: '最近，近来', sentences: [{ ja: 'このごろ太りました。', zh: '最近胖了。' }] },
    { id: 'L36-W23', category: 'Expressions', kanji: 'そのほうが', kana: 'そのほうが', romaji: 'sono hou ga', meaning: '那样更……', sentences: [{ ja: 'そのほうが体にいいです。', zh: '那样对身体更好。' }] },
    { id: 'L36-W24', category: 'Nouns', kanji: '水泳', kana: 'すいえい', romaji: 'suiei', meaning: '游泳', sentences: [{ ja: '水泳を習いたいです。', zh: '想学游泳。' }] }
  ],
  37: [
    { id: 'L37-W1', category: 'Verbs', grammarType: 'Group II', kanji: '褒めます', kana: 'ほめます', romaji: 'homemasu', meaning: '表扬', conjugations: { dictionary: '褒める', masu: 'ほめます', te: '褒めて', nai: '褒めない', ta: '褒めた' }, sentences: [{ ja: '先生に褒められました。', zh: '被老师表扬了。' }] },
    { id: 'L37-W2', category: 'Verbs', grammarType: 'Group II', kanji: '叱ります', kana: 'しかります', romaji: 'shikarimasu', meaning: '训斥', conjugations: { dictionary: '叱る', masu: 'しかります', te: '叱って', nai: '叱らない', ta: '叱った' }, sentences: [{ ja: '父に叱られました。', zh: '被父亲训斥了。' }] },
    { id: 'L37-W3', category: 'Verbs', grammarType: 'Group I', kanji: '誘います', kana: 'さそいます', romaji: 'sasoimasu', meaning: '邀请', conjugations: { dictionary: '誘う', masu: 'さそいます', te: '誘って', nai: '誘わない', ta: '誘った' }, sentences: [{ ja: '友達に映画に誘われました。', zh: '被朋友邀请去看电影。' }] },
    { id: 'L37-W4', category: 'Verbs', grammarType: 'Group I', kanji: '起こします', kana: 'おこします', romaji: 'okoshimasu', meaning: '叫醒', conjugations: { dictionary: '起こす', masu: 'おこします', te: '起こして', nai: '起こさない', ta: '起こした' }, sentences: [{ ja: '毎朝母に起こされます。', zh: '每天早上被妈妈叫醒。' }] },
    { id: 'L37-W5', category: 'Verbs', grammarType: 'Irregular', kanji: '招待します', kana: 'しょうたいします', romaji: 'shoutai shimasu', meaning: '邀请，招待', conjugations: { dictionary: '招待する', masu: 'しょうたいします', te: '招待して', nai: '招待しない', ta: '招待した' }, sentences: [{ ja: '結婚式に招待されました。', zh: '被邀请参加婚礼。' }] },
    { id: 'L37-W6', category: 'Verbs', grammarType: 'Group I', kanji: '頼みます', kana: 'たのみます', romaji: 'tanomimasu', meaning: '拜托，请求', conjugations: { dictionary: '頼む', masu: 'たのみます', te: '頼んで', nai: '頼まない', ta: '頼んだ' }, sentences: [{ ja: '仕事を頼まれました。', zh: '被拜托做工作。' }] },
    { id: 'L37-W7', category: 'Verbs', grammarType: 'Irregular', kanji: '注意します', kana: 'ちゅういします', romaji: 'chuui shimasu', meaning: '提醒，警告', conjugations: { dictionary: '注意する', masu: 'ちゅういします', te: '注意して', nai: '注意しない', ta: '注意した' }, sentences: [{ ja: '先生に注意されました。', zh: '被老师提醒了。' }] },
    { id: 'L37-W8', category: 'Verbs', grammarType: 'Group I', kanji: 'とります', kana: 'とります', romaji: 'torimasu', meaning: '偷，拿走', conjugations: { dictionary: 'とる', masu: 'とります', te: 'とって', nai: 'とらない', ta: 'とった' }, sentences: [{ ja: '泥棒に財布をとられました。', zh: '被小偷偷了钱包。' }] },
    { id: 'L37-W9', category: 'Verbs', grammarType: 'Group I', kanji: '踏みます', kana: 'ふみます', romaji: 'fumimasu', meaning: '踩', conjugations: { dictionary: '踏む', masu: 'ふみます', te: '踏んで', nai: '踏まない', ta: '踏んだ' }, sentences: [{ ja: '電車で足を踏まれました。', zh: '在电车上脚被踩了。' }] },
    { id: 'L37-W10', category: 'Verbs', grammarType: 'Group I', kanji: '壊します', kana: 'こわします', romaji: 'kowashimasu', meaning: '弄坏', conjugations: { dictionary: '壊す', masu: 'こわします', te: '壊して', nai: '壊さない', ta: '壊した' }, sentences: [{ ja: '子どもにカメラを壊されました。', zh: '相机被孩子弄坏了。' }] },
    { id: 'L37-W11', category: 'Verbs', grammarType: 'Group I', kanji: '汚します', kana: 'よごします', romaji: 'yogoshimasu', meaning: '弄脏', conjugations: { dictionary: '汚す', masu: 'よごします', te: '汚して', nai: '汚さない', ta: '汚した' }, sentences: [{ ja: '服を汚されました。', zh: '衣服被弄脏了。' }] },
    { id: 'L37-W12', category: 'Verbs', grammarType: 'Group I', kanji: '行います', kana: 'おこないます', romaji: 'okonaimasu', meaning: '举行，实施', conjugations: { dictionary: '行う', masu: 'おこないます', te: '行って', nai: '行わない', ta: '行った' }, sentences: [{ ja: 'オリンピックが東京で行われました。', zh: '奥运会在东京举行了。' }] },
    { id: 'L37-W13', category: 'Verbs', grammarType: 'Irregular', kanji: '輸出します', kana: 'ゆしゅつします', romaji: 'yushutsu shimasu', meaning: '出口，输出', conjugations: { dictionary: '輸出する', masu: 'ゆしゅつします', te: '輸出して', nai: '輸出しない', ta: '輸出した' }, sentences: [{ ja: '日本から車が輸出されています。', zh: '汽车从日本出口。' }] },
    { id: 'L37-W14', category: 'Verbs', grammarType: 'Irregular', kanji: '輸入します', kana: 'ゆにゅうします', romaji: 'yunyuu shimasu', meaning: '进口，输入', conjugations: { dictionary: '輸入する', masu: 'ゆにゅうします', te: '輸入して', nai: '輸入しない', ta: '輸入した' }, sentences: [{ ja: '石油が輸入されています。', zh: '石油被进口。' }] },
    { id: 'L37-W15', category: 'Verbs', grammarType: 'Irregular', kanji: '翻訳します', kana: 'ほんやくします', romaji: 'honyaku shimasu', meaning: '翻译', conjugations: { dictionary: '翻訳する', masu: 'ほんやくします', te: '翻訳して', nai: '翻訳しない', ta: '翻訳した' }, sentences: [{ ja: 'この本は英語に翻訳されました。', zh: '这本书被翻译成英语了。' }] },
    { id: 'L37-W16', category: 'Verbs', grammarType: 'Irregular', kanji: '発明します', kana: 'はつめいします', romaji: 'hatsumei shimasu', meaning: '发明', conjugations: { dictionary: '発明する', masu: 'はつめいします', te: '発明して', nai: '発明しない', ta: '発明した' }, sentences: [{ ja: '電話はベルによって発明されました。', zh: '电话是由贝尔发明的。' }] },
    { id: 'L37-W17', category: 'Verbs', grammarType: 'Irregular', kanji: '発見します', kana: 'はっけんします', romaji: 'hakken shimasu', meaning: '发现', conjugations: { dictionary: '発見する', masu: 'はっけんします', te: '発見して', nai: '発見しない', ta: '発見した' }, sentences: [{ ja: '新しい星が発見されました。', zh: '新星被发现了。' }] },
    { id: 'L37-W18', category: 'Nouns', kanji: '米', kana: 'こめ', romaji: 'kome', meaning: '米', sentences: [{ ja: '日本では米が作られています。', zh: '日本种植水稻。' }] },
    { id: 'L37-W19', category: 'Nouns', kanji: '麦', kana: 'むぎ', romaji: 'mugi', meaning: '麦子', sentences: [{ ja: '麦からビールが作られます。', zh: '啤酒由麦子制成。' }] },
    { id: 'L37-W20', category: 'Nouns', kanji: '石油', kana: 'せきゆ', romaji: 'sekiyu', meaning: '石油', sentences: [{ ja: '石油はサウジアラビアから輸入されています。', zh: '石油从沙特阿拉伯进口。' }] },
    { id: 'L37-W21', category: 'Nouns', kanji: '原料', kana: 'げんりょう', romaji: 'genryou', meaning: '原料', sentences: [{ ja: '紙の原料は木です。', zh: '纸的原料是木头。' }] },
    { id: 'L37-W22', category: 'Nouns', kanji: '泥棒', kana: 'どろぼう', romaji: 'dorobou', meaning: '小偷', sentences: [{ ja: '泥棒に入られました。', zh: '家里进小偷了。' }] },
    { id: 'L37-W23', category: 'Nouns', kanji: '警官', kana: 'けいかん', romaji: 'keikan', meaning: '警察', sentences: [{ ja: '警官に道を聞きました。', zh: '向警察问路。' }] },
    { id: 'L37-W24', category: 'Nouns', kanji: '建築家', kana: 'けんちくか', romaji: 'kenchikuka', meaning: '建筑师', sentences: [{ ja: 'この建物は有名な建築家によって建てられました。', zh: '这栋建筑是由著名建筑师建造的。' }] },
    { id: 'L37-W25', category: 'Nouns', kanji: '科学者', kana: 'かがくしゃ', romaji: 'kagakusha', meaning: '科学家', sentences: [{ ja: '科学者によって発見されました。', zh: '由科学家发现。' }] },
    { id: 'L37-W26', category: 'Nouns', kanji: '漫画', kana: 'まんが', romaji: 'manga', meaning: '漫画', sentences: [{ ja: 'この漫画は世界中で読まれています。', zh: '这部漫画在全世界被阅读。' }] },
    { id: 'L37-W27', category: 'Expressions', kanji: '世界中', kana: 'せかいじゅう', romaji: 'sekai juu', meaning: '全世界', sentences: [{ ja: '世界中で日本のアニメが見られています。', zh: '全世界都在看日本动画。' }] },
    { id: 'L37-W28', category: 'Expressions', kanji: '〜によって', kana: '〜によって', romaji: 'ni yotte', meaning: '由……，根据……', sentences: [{ ja: '源氏物語は紫式部によって書かれました。', zh: '《源氏物语》是由紫式部写的。' }] }
  ],
  38: [
    { id: 'L38-W1', category: 'Verbs', grammarType: 'Irregular', kanji: '参加します', kana: 'さんかします', romaji: 'sanka shimasu', meaning: '参加', conjugations: { dictionary: '参加する', masu: 'さんかします', te: '参加して', nai: '参加しない', ta: '参加した' }, sentences: [{ ja: 'パーティーに参加します。', zh: '参加派对。' }] },
    { id: 'L38-W2', category: 'Verbs', grammarType: 'Group II', kanji: '育てます', kana: 'そだてます', romaji: 'sodatemasu', meaning: '养育，培育', conjugations: { dictionary: '育てる', masu: 'そだてます', te: '育てて', nai: '育てない', ta: '育てた' }, sentences: [{ ja: '花を育てるのは楽しいです。', zh: '养花很开心。' }] },
    { id: 'L38-W3', category: 'Verbs', grammarType: 'Group I', kanji: '運びます', kana: 'はこびます', romaji: 'hakobimasu', meaning: '搬运', conjugations: { dictionary: '運ぶ', masu: 'はこびます', te: '運んで', nai: '運ばない', ta: '運んだ' }, sentences: [{ ja: '荷物を運びます。', zh: '搬运行李。' }] },
    { id: 'L38-W4', category: 'Verbs', grammarType: 'Irregular', kanji: '入院します', kana: 'にゅういんします', romaji: 'nyuuin shimasu', meaning: '住院', conjugations: { dictionary: '入院する', masu: 'にゅういんします', te: '入院して', nai: '入院しない', ta: '入院した' }, sentences: [{ ja: '父は病院に入院しています。', zh: '父亲住院了。' }] },
    { id: 'L38-W5', category: 'Verbs', grammarType: 'Irregular', kanji: '退院します', kana: 'たいいんします', romaji: 'taiin shimasu', meaning: '出院', conjugations: { dictionary: '退院する', masu: 'たいいんします', te: '退院して', nai: '退院しない', ta: '退院した' }, sentences: [{ ja: '来週退院します。', zh: '下周出院。' }] },
    { id: 'L38-W6', category: 'Verbs', grammarType: 'Group II', kanji: '入れます', kana: 'いれます', romaji: 'iremasu', meaning: '放入，打开（电源）', conjugations: { dictionary: '入れる', masu: 'いれます', te: '入れて', nai: '入れない', ta: '入れた' }, sentences: [{ ja: '電源を入れます。', zh: '打开电源。' }] },
    { id: 'L38-W7', category: 'Verbs', grammarType: 'Group I', kanji: '切ります', kana: 'きります', romaji: 'kirimasu', meaning: '切；关（电源）', conjugations: { dictionary: '切る', masu: 'きります', te: '切って', nai: '切らない', ta: '切った' }, sentences: [{ ja: '電源を切るのを忘れました。', zh: '忘了关电源。' }] },
    { id: 'L38-W8', category: 'Verbs', grammarType: 'Group II', kanji: '掛けます', kana: 'かけます', romaji: 'kakemasu', meaning: '锁上；挂', conjugations: { dictionary: '掛ける', masu: 'かけます', te: '掛けて', nai: '掛けない', ta: '掛けた' }, sentences: [{ ja: '鍵を掛けるのを忘れました。', zh: '忘了锁门。' }] },
    { id: 'L38-W9', category: 'Adjectives', grammarType: 'i-adj', kanji: '気持ちがいい', kana: 'きもちがいい', romaji: 'kimochi ga ii', meaning: '心情好，舒服', sentences: [{ ja: '朝散歩するのは気持ちがいいです。', zh: '早上散步很舒服。' }] },
    { id: 'L38-W10', category: 'Nouns', kanji: 'うそ', kana: 'うそ', romaji: 'uso', meaning: '谎言', sentences: [{ ja: 'うそをつくのはいけません。', zh: '撒谎是不行的。' }] },
    { id: 'L38-W11', category: 'Nouns', kanji: '赤ちゃん', kana: 'あかちゃん', romaji: 'akachan', meaning: '婴儿', sentences: [{ ja: '赤ちゃんが寝ています。', zh: '婴儿在睡觉。' }] },
    { id: 'L38-W12', category: 'Nouns', kanji: 'お年寄り', kana: 'おとしより', romaji: 'otoshiyori', meaning: '老人', sentences: [{ ja: 'お年寄りに席を譲ります。', zh: '给老人让座。' }] },
    { id: 'L38-W13', category: 'Nouns', kanji: '駅前', kana: 'えきまえ', romaji: 'ekimae', meaning: '车站前', sentences: [{ ja: '駅前に新しい店ができました。', zh: '车站前开了一家新店。' }] },
    { id: 'L38-W14', category: 'Nouns', kanji: '海岸', kana: 'かいがん', romaji: 'kaigan', meaning: '海岸', sentences: [{ ja: '海岸を散歩します。', zh: '在海岸散步。' }] },
    { id: 'L38-W15', category: 'Nouns', kanji: '村', kana: 'むら', romaji: 'mura', meaning: '村庄', sentences: [{ ja: '祖母は小さい村に住んでいます。', zh: '祖母住在小村庄。' }] },
    { id: 'L38-W16', category: 'Nouns', kanji: '研究室', kana: 'けんきゅうしつ', romaji: 'kenkyuushitsu', meaning: '研究室', sentences: [{ ja: '先生は研究室にいます。', zh: '老师在研究室。' }] },
    { id: 'L38-W17', category: 'Nouns', kanji: 'きちんと', kana: 'きちんと', romaji: 'kichinto', meaning: '整齐地，认真地', sentences: [{ ja: '資料をきちんと整理します。', zh: '把资料整理好。' }] },
    { id: 'L38-W18', category: 'Nouns', kanji: '整理', kana: 'せいり', romaji: 'seiri', meaning: '整理', sentences: [{ ja: '部屋の整理をします。', zh: '整理房间。' }] },
    { id: 'L38-W19', category: 'Nouns', kanji: '方法', kana: 'ほうほう', romaji: 'houhou', meaning: '方法', sentences: [{ ja: 'いい方法を考えます。', zh: '想一个好方法。' }] },
    { id: 'L38-W20', category: 'Adjectives', grammarType: 'i-adj', kanji: '珍しい', kana: 'めずらしい', romaji: 'mezurashii', meaning: '少见，稀奇', sentences: [{ ja: '珍しい花ですね。', zh: '真是少见的花啊。' }] },
    { id: 'L38-W21', category: 'Expressions', kanji: 'かな', kana: 'かな', romaji: 'kana', meaning: '……吧，……呢（自言自语）', sentences: [{ ja: '明日は晴れるかな。', zh: '明天会晴吧。' }] }
  ],
  39: [
    { id: 'L39-W1', category: 'Verbs', grammarType: 'Group II', kanji: '答えます', kana: 'こたえます', romaji: 'kotaemasu', meaning: '回答', conjugations: { dictionary: '答える', masu: 'こたえます', te: '答えて', nai: '答えない', ta: '答えた' }, sentences: [{ ja: '質問に答えます。', zh: '回答问题。' }] },
    { id: 'L39-W2', category: 'Verbs', grammarType: 'Group II', kanji: '倒れます', kana: 'たおれます', romaji: 'taoremasu', meaning: '倒塌，倒下', conjugations: { dictionary: '倒れる', masu: 'たおれます', te: '倒れて', nai: '倒れない', ta: '倒れた' }, sentences: [{ ja: '地震でビルが倒れました。', zh: '因为地震大楼倒塌了。' }] },
    { id: 'L39-W3', category: 'Verbs', grammarType: 'Group II', kanji: '焼けます', kana: 'やけます', romaji: 'yakemasu', meaning: '烧毁，烤好', conjugations: { dictionary: '焼ける', masu: 'やけます', te: '焼けて', nai: '焼けない', ta: '焼けた' }, sentences: [{ ja: '火事で家が焼けました。', zh: '房子因火灾烧毁了。' }] },
    { id: 'L39-W4', category: 'Verbs', grammarType: 'Group I', kanji: '通ります', kana: 'とおります', romaji: 'toorimasu', meaning: '通过，经过', conjugations: { dictionary: '通る', masu: 'とおります', te: '通って', nai: '通らない', ta: '通った' }, sentences: [{ ja: '道を通ります。', zh: '经过道路。' }] },
    { id: 'L39-W5', category: 'Verbs', grammarType: 'Group I', kanji: '死にます', kana: 'しにます', romaji: 'shinimasu', meaning: '死', conjugations: { dictionary: '死ぬ', masu: 'しにます', te: '死んで', nai: '死なない', ta: '死んだ' }, sentences: [{ ja: '事故で人が死にました。', zh: '有人因事故去世了。' }] },
    { id: 'L39-W6', category: 'Verbs', grammarType: 'Irregular', kanji: 'びっくりします', kana: 'びっくりします', romaji: 'bikkuri shimasu', meaning: '吃惊', conjugations: { dictionary: 'びっくりする', masu: 'びっくりします', te: 'びっくりして', nai: 'びっくりしない', ta: 'びっくりした' }, sentences: [{ ja: 'ニュースを聞いて、びっくりしました。', zh: '听到新闻吓了一跳。' }] },
    { id: 'L39-W7', category: 'Verbs', grammarType: 'Irregular', kanji: 'がっかりします', kana: 'がっかりします', romaji: 'gakkari shimasu', meaning: '失望', conjugations: { dictionary: 'がっかりする', masu: 'がっかりします', te: 'がっかりして', nai: 'がっかりしない', ta: 'がっかりした' }, sentences: [{ ja: '試験に落ちて、がっかりしました。', zh: '考试没通过，很失望。' }] },
    { id: 'L39-W8', category: 'Verbs', grammarType: 'Irregular', kanji: '安心します', kana: 'あんしんします', romaji: 'anshin shimasu', meaning: '放心，安心', conjugations: { dictionary: '安心する', masu: 'あんしんします', te: '安心して', nai: '安心しない', ta: '安心した' }, sentences: [{ ja: '家族の声を聞いて、安心しました。', zh: '听到家人的声音，放心了。' }] },
    { id: 'L39-W9', category: 'Verbs', grammarType: 'Irregular', kanji: '遅刻します', kana: 'ちこくします', romaji: 'chikoku shimasu', meaning: '迟到', conjugations: { dictionary: '遅刻する', masu: 'ちこくします', te: '遅刻して', nai: '遅刻しない', ta: '遅刻した' }, sentences: [{ ja: '寝坊して、学校に遅刻しました。', zh: '睡过头所以上学迟到了。' }] },
    { id: 'L39-W10', category: 'Verbs', grammarType: 'Irregular', kanji: '早退します', kana: 'そうたいします', romaji: 'soutai shimasu', meaning: '早退', conjugations: { dictionary: '早退する', masu: 'そうたいします', te: '早退して', nai: '早退しない', ta: '早退した' }, sentences: [{ ja: '熱があるので、早退します。', zh: '因为发烧，所以早退。' }] },
    { id: 'L39-W11', category: 'Verbs', grammarType: 'Irregular', kanji: 'けんかします', kana: 'けんかします', romaji: 'kenka shimasu', meaning: '吵架，打架', conjugations: { dictionary: 'けんかする', masu: 'けんかします', te: 'けんかして', nai: 'けんかしない', ta: 'けんかした' }, sentences: [{ ja: '兄とけんかしました。', zh: '和哥哥吵架了。' }] },
    { id: 'L39-W12', category: 'Verbs', grammarType: 'Irregular', kanji: '離婚します', kana: 'りこんします', romaji: 'rikon shimasu', meaning: '离婚', conjugations: { dictionary: '離婚する', masu: 'りこんします', te: '離婚して', nai: '離婚しない', ta: '離婚した' }, sentences: [{ ja: '両親は離婚しました。', zh: '父母离婚了。' }] },
    { id: 'L39-W13', category: 'Adjectives', grammarType: 'na-adj', kanji: '複雑', kana: 'ふくざつ', romaji: 'fukuzatsu', meaning: '复杂', sentences: [{ ja: '使い方が複雑です。', zh: '使用方法很复杂。' }] },
    { id: 'L39-W14', category: 'Adjectives', grammarType: 'na-adj', kanji: '邪魔', kana: 'じゃま', romaji: 'jama', meaning: '碍事，打扰', sentences: [{ ja: '邪魔しないでください。', zh: '请不要打扰。' }] },
    { id: 'L39-W15', category: 'Adjectives', grammarType: 'i-adj', kanji: '汚い', kana: 'きたない', romaji: 'kitanai', meaning: '脏', sentences: [{ ja: '部屋が汚いです。', zh: '房间很脏。' }] },
    { id: 'L39-W16', category: 'Adjectives', grammarType: 'i-adj', kanji: 'うれしい', kana: 'うれしい', romaji: 'ureshii', meaning: '高兴', sentences: [{ ja: '合格して、うれしいです。', zh: '考上了，很高兴。' }] },
    { id: 'L39-W17', category: 'Adjectives', grammarType: 'i-adj', kanji: '悲しい', kana: 'かなしい', romaji: 'kanashii', meaning: '悲伤', sentences: [{ ja: '悲しいニュースを聞きました。', zh: '听到了悲伤的新闻。' }] },
    { id: 'L39-W18', category: 'Adjectives', grammarType: 'i-adj', kanji: '恥ずかしい', kana: 'はずかしい', romaji: 'hazukashii', meaning: '害羞，难为情', sentences: [{ ja: 'みんなの前で話すのは恥ずかしいです。', zh: '在大家面前讲话很害羞。' }] },
    { id: 'L39-W19', category: 'Nouns', kanji: '地震', kana: 'じしん', romaji: 'jishin', meaning: '地震', sentences: [{ ja: '地震でビルが倒れました。', zh: '因为地震大楼倒塌了。' }] },
    { id: 'L39-W20', category: 'Nouns', kanji: '台風', kana: 'たいふう', romaji: 'taifuu', meaning: '台风', sentences: [{ ja: '台風で電車が止まりました。', zh: '因为台风电车停运了。' }] },
    { id: 'L39-W21', category: 'Nouns', kanji: '火事', kana: 'かじ', romaji: 'kaji', meaning: '火灾', sentences: [{ ja: '火事で家が焼けました。', zh: '房子因火灾烧毁了。' }] },
    { id: 'L39-W22', category: 'Nouns', kanji: '事故', kana: 'じこ', romaji: 'jiko', meaning: '事故', sentences: [{ ja: '事故でバスが遅れました。', zh: '因为事故公交晚点了。' }] },
    { id: 'L39-W23', category: 'Nouns', kanji: 'お見合い', kana: 'おみあい', romaji: 'omiai', meaning: '相亲', sentences: [{ ja: '友達がお見合いをしました。', zh: '朋友去相亲了。' }] },
    { id: 'L39-W24', category: 'Nouns', kanji: '電話代', kana: 'でんわだい', romaji: 'denwa dai', meaning: '电话费', sentences: [{ ja: '電話代が高くて、びっくりしました。', zh: '电话费很贵，吓了一跳。' }] },
    { id: 'L39-W25', category: 'Nouns', kanji: 'フロント', kana: 'フロント', romaji: 'furonto', meaning: '前台', sentences: [{ ja: 'フロントで聞いてください。', zh: '请在前台询问。' }] },
    { id: 'L39-W26', category: 'Nouns', kanji: '号室', kana: 'ごうしつ', romaji: 'goushitsu', meaning: '号房间', sentences: [{ ja: '305号室に泊まっています。', zh: '住在305号房。' }] },
    { id: 'L39-W27', category: 'Expressions', kanji: 'お疲れさまでした', kana: 'おつかれさまでした', romaji: 'otsukaresama deshita', meaning: '辛苦了', sentences: [{ ja: 'きょうはお疲れさまでした。', zh: '今天辛苦了。' }] }
  ],
  40: [
    { id: 'L40-W1', category: 'Verbs', grammarType: 'Group II', kanji: '数えます', kana: 'かぞえます', romaji: 'kazoemasu', meaning: '数', conjugations: { dictionary: '数える', masu: 'かぞえます', te: '数えて', nai: '数えない', ta: '数えた' }, sentences: [{ ja: '人数を数えます。', zh: '数人数。' }] },
    { id: 'L40-W2', category: 'Verbs', grammarType: 'Group I', kanji: '測ります', kana: 'はかります', romaji: 'hakarimasu', meaning: '测量（长度、高度等）', conjugations: { dictionary: '測る', masu: 'はかります', te: '測って', nai: '測らない', ta: '測った' }, sentences: [{ ja: '長さを測ります。', zh: '测量长度。' }] },
    { id: 'L40-W3', category: 'Verbs', grammarType: 'Group I', kanji: '量ります', kana: 'はかります', romaji: 'hakarimasu', meaning: '称量（重量等）', conjugations: { dictionary: '量る', masu: 'はかります', te: '量って', nai: '量らない', ta: '量った' }, sentences: [{ ja: '重さを量ります。', zh: '称重量。' }] },
    { id: 'L40-W4', category: 'Verbs', grammarType: 'Group II', kanji: '確かめます', kana: 'たしかめます', romaji: 'tashikamemasu', meaning: '确认', conjugations: { dictionary: '確かめる', masu: 'たしかめます', te: '確かめて', nai: '確かめない', ta: '確かめた' }, sentences: [{ ja: '忘れ物がないか、確かめてください。', zh: '请确认有没有忘带东西。' }] },
    { id: 'L40-W5', category: 'Verbs', grammarType: 'Group I', kanji: '合います', kana: 'あいます', romaji: 'aimasu', meaning: '合适，合身', conjugations: { dictionary: '合う', masu: 'あいます', te: '合って', nai: '合わない', ta: '合った' }, sentences: [{ ja: 'このズボンはサイズが合います。', zh: '这条裤子的尺码合适。' }] },
    { id: 'L40-W6', category: 'Verbs', grammarType: 'Irregular', kanji: '出発します', kana: 'しゅっぱつします', romaji: 'shuppatsu shimasu', meaning: '出发', conjugations: { dictionary: '出発する', masu: 'しゅっぱつします', te: '出発して', nai: '出発しない', ta: '出発した' }, sentences: [{ ja: '何時に出発するか、調べます。', zh: '查一下几点出发。' }] },
    { id: 'L40-W7', category: 'Verbs', grammarType: 'Irregular', kanji: '到着します', kana: 'とうちゃくします', romaji: 'touchaku shimasu', meaning: '到达', conjugations: { dictionary: '到着する', masu: 'とうちゃくします', te: '到着して', nai: '到着しない', ta: '到着した' }, sentences: [{ ja: 'いつ到着するか、聞いてください。', zh: '请问一下什么时候到。' }] },
    { id: 'L40-W8', category: 'Verbs', grammarType: 'Group I', kanji: '酔います', kana: 'よいます', romaji: 'yoimasu', meaning: '醉；晕车船', conjugations: { dictionary: '酔う', masu: 'よいます', te: '酔って', nai: '酔わない', ta: '酔った' }, sentences: [{ ja: '船に酔いました。', zh: '晕船了。' }] },
    { id: 'L40-W9', category: 'Verbs', grammarType: 'Group I', kanji: 'うまくいきます', kana: 'うまくいきます', romaji: 'umaku ikimasu', meaning: '顺利进行', conjugations: { dictionary: 'うまくいく', masu: 'うまくいきます', te: 'うまくいって', nai: 'うまくいかない', ta: 'うまくいった' }, sentences: [{ ja: '仕事がうまくいっています。', zh: '工作进行得很顺利。' }] },
    { id: 'L40-W10', category: 'Nouns', kanji: '問題', kana: 'もんだい', romaji: 'mondai', meaning: '问题', sentences: [{ ja: '問題があるかどうか、調べます。', zh: '调查有没有问题。' }] },
    { id: 'L40-W11', category: 'Nouns', kanji: '答え', kana: 'こたえ', romaji: 'kotae', meaning: '答案', sentences: [{ ja: '答えが正しいかどうか、確かめます。', zh: '确认答案是否正确。' }] },
    { id: 'L40-W12', category: 'Nouns', kanji: '間違い', kana: 'まちがい', romaji: 'machigai', meaning: '错误', sentences: [{ ja: '間違いがないか、見てください。', zh: '请看看有没有错误。' }] },
    { id: 'L40-W13', category: 'Nouns', kanji: '傷', kana: 'きず', romaji: 'kizu', meaning: '伤，瑕疵', sentences: [{ ja: '傷がないか、調べます。', zh: '检查有没有划痕。' }] },
    { id: 'L40-W14', category: 'Nouns', kanji: 'ズボン', kana: 'ズボン', romaji: 'zubon', meaning: '裤子', sentences: [{ ja: 'このズボンをはいてみてもいいですか。', zh: '可以试穿这条裤子吗？' }] },
    { id: 'L40-W15', category: 'Nouns', kanji: '長さ', kana: 'ながさ', romaji: 'nagasa', meaning: '长度', sentences: [{ ja: '長さを測ります。', zh: '测量长度。' }] },
    { id: 'L40-W16', category: 'Nouns', kanji: '重さ', kana: 'おもさ', romaji: 'omosa', meaning: '重量', sentences: [{ ja: '重さを量ります。', zh: '称重量。' }] },
    { id: 'L40-W17', category: 'Nouns', kanji: '高さ', kana: 'たかさ', romaji: 'takasa', meaning: '高度', sentences: [{ ja: '高さを測ります。', zh: '测量高度。' }] },
    { id: 'L40-W18', category: 'Nouns', kanji: '大きさ', kana: 'おおきさ', romaji: 'ookisa', meaning: '大小', sentences: [{ ja: '大きさを比べます。', zh: '比较大小。' }] },
    { id: 'L40-W19', category: 'Nouns', kanji: '便', kana: 'びん', romaji: 'bin', meaning: '航班，班次', sentences: [{ ja: '飛行機の便を調べます。', zh: '查飞机航班。' }] },
    { id: 'L40-W20', category: 'Counters', kanji: '台', kana: 'だい', romaji: 'dai', meaning: '台（机器、车辆的量词）', sentences: [{ ja: '車が3台あります。', zh: '有三辆车。' }] },
    { id: 'L40-W21', category: 'Counters', kanji: '個', kana: 'こ', romaji: 'ko', meaning: '个（小物品量词）', sentences: [{ ja: 'りんごを3個買いました。', zh: '买了三个苹果。' }] },
    { id: 'L40-W22', category: 'Counters', kanji: '本', kana: 'ほん', romaji: 'hon', meaning: '根，瓶，条（细长物量词）', sentences: [{ ja: '鉛筆が5本あります。', zh: '有五支铅笔。' }] },
    { id: 'L40-W23', category: 'Counters', kanji: '杯', kana: 'はい', romaji: 'hai', meaning: '杯，碗', sentences: [{ ja: 'コーヒーを一杯飲みます。', zh: '喝一杯咖啡。' }] },
    { id: 'L40-W24', category: 'Counters', kanji: 'キロ', kana: 'キロ', romaji: 'kiro', meaning: '千克；千米', sentences: [{ ja: '駅まで2キロあります。', zh: '到车站有两公里。' }] },
    { id: 'L40-W25', category: 'Counters', kanji: 'センチ', kana: 'センチ', romaji: 'senchi', meaning: '厘米', sentences: [{ ja: '長さは30センチです。', zh: '长度是30厘米。' }] },
    { id: 'L40-W26', category: 'Expressions', kanji: '以上', kana: 'いじょう', romaji: 'ijou', meaning: '以上，不少于', sentences: [{ ja: '18歳以上です。', zh: '18岁以上。' }] },
    { id: 'L40-W27', category: 'Expressions', kanji: '以下', kana: 'いか', romaji: 'ika', meaning: '以下，不超过', sentences: [{ ja: '1000円以下です。', zh: '1000日元以下。' }] },
    { id: 'L40-W28', category: 'Expressions', kanji: 'さあ', kana: 'さあ', romaji: 'saa', meaning: '这个嘛，不太清楚', sentences: [{ ja: 'さあ、どうでしょうか。', zh: '这个嘛，不知道怎么样。' }] },
    { id: 'L40-W29', category: 'Expressions', kanji: 'どうでしょうか', kana: 'どうでしょうか', romaji: 'dou deshou ka', meaning: '怎么样呢', sentences: [{ ja: 'ちょっと着てみてください。どうでしょうか。', zh: '请试穿一下。怎么样呢？' }] }
  ],
  41: [
    { id: 'L41-W1', category: 'Verbs', grammarType: 'Group I', kanji: 'いただきます', kana: 'いただきます', romaji: 'itadakimasu', meaning: '得到，领受（もらいます的谦让语）', conjugations: { dictionary: 'いただく', masu: 'いただきます', te: 'いただいて', nai: 'いただかない', ta: 'いただいた' }, sentences: [{ ja: '先生に本をいただきました。', zh: '我从老师那里得到了书。' }] },
    { id: 'L41-W2', category: 'Verbs', grammarType: 'Group I', kanji: 'くださいます', kana: 'くださいます', romaji: 'kudasaimasu', meaning: '给我（くれます的尊敬语）', conjugations: { dictionary: 'くださる', masu: 'くださいます', te: 'くださって', nai: 'くださらない', ta: 'くださった' }, sentences: [{ ja: '部長が資料をくださいました。', zh: '部长给了我资料。' }] },
    { id: 'L41-W3', category: 'Verbs', grammarType: 'Group I', kanji: 'やります', kana: 'やります', romaji: 'yarimasu', meaning: '给（晚辈、动植物）', conjugations: { dictionary: 'やる', masu: 'やります', te: 'やって', nai: 'やらない', ta: 'やった' }, sentences: [{ ja: '犬にえさをやります。', zh: '给狗喂食。' }] },
    { id: 'L41-W4', category: 'Verbs', grammarType: 'Group I', kanji: '呼びます', kana: 'よびます', romaji: 'yobimasu', meaning: '叫，邀请', conjugations: { dictionary: '呼ぶ', masu: 'よびます', te: '呼んで', nai: '呼ばない', ta: '呼んだ' }, sentences: [{ ja: 'タクシーを呼んでください。', zh: '请叫出租车。' }] },
    { id: 'L41-W5', category: 'Verbs', grammarType: 'Group II', kanji: '取り替えます', kana: 'とりかえます', romaji: 'torikaemasu', meaning: '更换', conjugations: { dictionary: '取り替える', masu: 'とりかえます', te: '取り替えて', nai: '取り替えない', ta: '取り替えた' }, sentences: [{ ja: '電池を取り替えます。', zh: '更换电池。' }] },
    { id: 'L41-W6', category: 'Verbs', grammarType: 'Irregular', kanji: '親切にします', kana: 'しんせつにします', romaji: 'shinsetsu ni shimasu', meaning: '亲切对待', conjugations: { dictionary: '親切にする', masu: 'しんせつにします', te: '親切にして', nai: '親切にしない', ta: '親切にした' }, sentences: [{ ja: 'お年寄りに親切にします。', zh: '亲切对待老人。' }] },
    { id: 'L41-W7', category: 'Nouns', kanji: 'お祝い', kana: 'おいわい', romaji: 'oiwai', meaning: '祝贺，贺礼', sentences: [{ ja: '入学のお祝いをいただきました。', zh: '收到了入学贺礼。' }] },
    { id: 'L41-W8', category: 'Nouns', kanji: 'お年玉', kana: 'おとしだま', romaji: 'otoshidama', meaning: '压岁钱', sentences: [{ ja: '子どもにお年玉をやります。', zh: '给孩子压岁钱。' }] },
    { id: 'L41-W9', category: 'Nouns', kanji: 'お見舞い', kana: 'おみまい', romaji: 'omimai', meaning: '探病，慰问', sentences: [{ ja: '友達のお見舞いに行きます。', zh: '去探望生病的朋友。' }] },
    { id: 'L41-W10', category: 'Nouns', kanji: '興味', kana: 'きょうみ', romaji: 'kyoumi', meaning: '兴趣', sentences: [{ ja: '日本の歴史に興味があります。', zh: '对日本历史感兴趣。' }] },
    { id: 'L41-W11', category: 'Nouns', kanji: '情報', kana: 'じょうほう', romaji: 'jouhou', meaning: '信息', sentences: [{ ja: '旅行の情報を集めます。', zh: '收集旅行信息。' }] },
    { id: 'L41-W12', category: 'Nouns', kanji: '文法', kana: 'ぶんぽう', romaji: 'bunpou', meaning: '语法', sentences: [{ ja: '先生が文法を説明してくださいました。', zh: '老师给我们讲解了语法。' }] },
    { id: 'L41-W13', category: 'Nouns', kanji: '発音', kana: 'はつおん', romaji: 'hatsuon', meaning: '发音', sentences: [{ ja: '発音を直していただきました。', zh: '请老师帮我纠正了发音。' }] },
    { id: 'L41-W14', category: 'Nouns', kanji: '猿', kana: 'さる', romaji: 'saru', meaning: '猴子', sentences: [{ ja: '猿にえさをやらないでください。', zh: '请不要给猴子喂食。' }] },
    { id: 'L41-W15', category: 'Nouns', kanji: 'えさ', kana: 'えさ', romaji: 'esa', meaning: '饲料，食物', sentences: [{ ja: '犬にえさをやります。', zh: '给狗喂食。' }] },
    { id: 'L41-W16', category: 'Nouns', kanji: 'おもちゃ', kana: 'おもちゃ', romaji: 'omocha', meaning: '玩具', sentences: [{ ja: '子どもにおもちゃをやりました。', zh: '给了孩子玩具。' }] },
    { id: 'L41-W17', category: 'Nouns', kanji: '絵本', kana: 'えほん', romaji: 'ehon', meaning: '图画书', sentences: [{ ja: '妹に絵本をやります。', zh: '给妹妹图画书。' }] },
    { id: 'L41-W18', category: 'Nouns', kanji: '手袋', kana: 'てぶくろ', romaji: 'tebukuro', meaning: '手套', sentences: [{ ja: '母に手袋をいただきました。', zh: '从母亲那里收到了手套。' }] },
    { id: 'L41-W19', category: 'Nouns', kanji: '指輪', kana: 'ゆびわ', romaji: 'yubiwa', meaning: '戒指', sentences: [{ ja: '祖母に指輪をいただきました。', zh: '从祖母那里收到了戒指。' }] },
    { id: 'L41-W20', category: 'Nouns', kanji: '孫', kana: 'まご', romaji: 'mago', meaning: '孙子，孙女', sentences: [{ ja: '祖父は孫にお年玉をやりました。', zh: '祖父给孙辈压岁钱。' }] }
  ],
  42: [
    { id: 'L42-W1', category: 'Verbs', grammarType: 'Group I', kanji: '包みます', kana: 'つつみます', romaji: 'tsutsumimasu', meaning: '包，裹', conjugations: { dictionary: '包む', masu: 'つつみます', te: '包んで', nai: '包まない', ta: '包んだ' }, sentences: [{ ja: 'プレゼントを包みます。', zh: '包装礼物。' }] },
    { id: 'L42-W2', category: 'Verbs', grammarType: 'Group I', kanji: '沸かします', kana: 'わかします', romaji: 'wakashimasu', meaning: '烧开', conjugations: { dictionary: '沸かす', masu: 'わかします', te: '沸かして', nai: '沸かさない', ta: '沸かした' }, sentences: [{ ja: 'お茶を飲むために、お湯を沸かします。', zh: '为了喝茶，烧开水。' }] },
    { id: 'L42-W3', category: 'Verbs', grammarType: 'Group II', kanji: '混ぜます', kana: 'まぜます', romaji: 'mazemasu', meaning: '混合，搅拌', conjugations: { dictionary: '混ぜる', masu: 'まぜます', te: '混ぜて', nai: '混ぜない', ta: '混ぜた' }, sentences: [{ ja: '材料をよく混ぜます。', zh: '把材料充分搅拌。' }] },
    { id: 'L42-W4', category: 'Verbs', grammarType: 'Irregular', kanji: '計算します', kana: 'けいさんします', romaji: 'keisan shimasu', meaning: '计算', conjugations: { dictionary: '計算する', masu: 'けいさんします', te: '計算して', nai: '計算しない', ta: '計算した' }, sentences: [{ ja: 'そろばんで計算します。', zh: '用算盘计算。' }] },
    { id: 'L42-W5', category: 'Adjectives', grammarType: 'i-adj', kanji: '厚い', kana: 'あつい', romaji: 'atsui', meaning: '厚', sentences: [{ ja: '厚い本を読みました。', zh: '读了厚厚的书。' }] },
    { id: 'L42-W6', category: 'Adjectives', grammarType: 'i-adj', kanji: '薄い', kana: 'うすい', romaji: 'usui', meaning: '薄；淡', sentences: [{ ja: 'この紙は薄いです。', zh: '这张纸很薄。' }] },
    { id: 'L42-W7', category: 'Nouns', kanji: '弁護士', kana: 'べんごし', romaji: 'bengoshi', meaning: '律师', sentences: [{ ja: '弁護士になるために、法律を勉強しています。', zh: '为了成为律师，正在学习法律。' }] },
    { id: 'L42-W8', category: 'Nouns', kanji: '音楽家', kana: 'おんがくか', romaji: 'ongakuka', meaning: '音乐家', sentences: [{ ja: '音楽家になるために、毎日練習します。', zh: '为了成为音乐家，每天练习。' }] },
    { id: 'L42-W9', category: 'Nouns', kanji: '教育', kana: 'きょういく', romaji: 'kyouiku', meaning: '教育', sentences: [{ ja: '教育について研究します。', zh: '研究教育。' }] },
    { id: 'L42-W10', category: 'Nouns', kanji: '文化', kana: 'ぶんか', romaji: 'bunka', meaning: '文化', sentences: [{ ja: '日本の文化を知るために留学します。', zh: '为了了解日本文化而留学。' }] },
    { id: 'L42-W11', category: 'Nouns', kanji: '社会', kana: 'しゃかい', romaji: 'shakai', meaning: '社会', sentences: [{ ja: '社会の問題について話します。', zh: '谈论社会问题。' }] },
    { id: 'L42-W12', category: 'Nouns', kanji: '法律', kana: 'ほうりつ', romaji: 'houritsu', meaning: '法律', sentences: [{ ja: '法律を勉強します。', zh: '学习法律。' }] },
    { id: 'L42-W13', category: 'Nouns', kanji: '戦争', kana: 'せんそう', romaji: 'sensou', meaning: '战争', sentences: [{ ja: '戦争についての本を読みました。', zh: '读了关于战争的书。' }] },
    { id: 'L42-W14', category: 'Nouns', kanji: '平和', kana: 'へいわ', romaji: 'heiwa', meaning: '和平', sentences: [{ ja: '平和のために働きます。', zh: '为和平而工作。' }] },
    { id: 'L42-W15', category: 'Nouns', kanji: '目的', kana: 'もくてき', romaji: 'mokuteki', meaning: '目的', sentences: [{ ja: '旅行の目的は何ですか。', zh: '旅行的目的是什么？' }] },
    { id: 'L42-W16', category: 'Nouns', kanji: '論文', kana: 'ろんぶん', romaji: 'ronbun', meaning: '论文', sentences: [{ ja: '論文を書くために、資料を集めています。', zh: '为了写论文，正在收集资料。' }] },
    { id: 'L42-W17', category: 'Nouns', kanji: 'ミキサー', kana: 'ミキサー', romaji: 'mikisaa', meaning: '搅拌机', sentences: [{ ja: 'ジュースを作るのにミキサーを使います。', zh: '做果汁用搅拌机。' }] },
    { id: 'L42-W18', category: 'Nouns', kanji: 'やかん', kana: 'やかん', romaji: 'yakan', meaning: '水壶', sentences: [{ ja: 'やかんでお湯を沸かします。', zh: '用水壶烧水。' }] },
    { id: 'L42-W19', category: 'Nouns', kanji: '缶切り', kana: 'かんきり', romaji: 'kankiri', meaning: '开罐器', sentences: [{ ja: '缶詰を開けるのに缶切りが必要です。', zh: '开罐头需要开罐器。' }] },
    { id: 'L42-W20', category: 'Nouns', kanji: '風呂敷', kana: 'ふろしき', romaji: 'furoshiki', meaning: '包袱布', sentences: [{ ja: '風呂敷は物を包むのに使います。', zh: '包袱布用于包东西。' }] },
    { id: 'L42-W21', category: 'Nouns', kanji: '材料', kana: 'ざいりょう', romaji: 'zairyou', meaning: '材料', sentences: [{ ja: '料理の材料を買います。', zh: '购买料理材料。' }] },
    { id: 'L42-W22', category: 'Nouns', kanji: 'データ', kana: 'データ', romaji: 'deeta', meaning: '数据', sentences: [{ ja: 'データを保存します。', zh: '保存数据。' }] }
  ],
  43: [
    { id: 'L43-W1', category: 'Verbs', grammarType: 'Group II', kanji: '増えます', kana: 'ふえます', romaji: 'fuemasu', meaning: '增加', conjugations: { dictionary: '増える', masu: 'ふえます', te: '増えて', nai: '増えない', ta: '増えた' }, sentences: [{ ja: '輸出が増えました。', zh: '出口增加了。' }] },
    { id: 'L43-W2', category: 'Verbs', grammarType: 'Group II', kanji: '減ります', kana: 'へります', romaji: 'herimasu', meaning: '减少', conjugations: { dictionary: '減る', masu: 'へります', te: '減って', nai: '減らない', ta: '減った' }, sentences: [{ ja: '人口が減っています。', zh: '人口正在减少。' }] },
    { id: 'L43-W3', category: 'Verbs', grammarType: 'Group I', kanji: '上がります', kana: 'あがります', romaji: 'agarimasu', meaning: '上涨，上升', conjugations: { dictionary: '上がる', masu: 'あがります', te: '上がって', nai: '上がらない', ta: '上がった' }, sentences: [{ ja: 'ガソリンの値段が上がりました。', zh: '汽油价格上涨了。' }] },
    { id: 'L43-W4', category: 'Verbs', grammarType: 'Group I', kanji: '下がります', kana: 'さがります', romaji: 'sagarimasu', meaning: '下降，下跌', conjugations: { dictionary: '下がる', masu: 'さがります', te: '下がって', nai: '下がらない', ta: '下がった' }, sentences: [{ ja: '気温が下がりました。', zh: '气温下降了。' }] },
    { id: 'L43-W5', category: 'Verbs', grammarType: 'Group II', kanji: '切れます', kana: 'きれます', romaji: 'kiremasu', meaning: '断；用完', conjugations: { dictionary: '切れる', masu: 'きれます', te: '切れて', nai: '切れない', ta: '切れた' }, sentences: [{ ja: '電池が切れそうです。', zh: '电池快没电了。' }] },
    { id: 'L43-W6', category: 'Verbs', grammarType: 'Group II', kanji: 'とれます', kana: 'とれます', romaji: 'toremasu', meaning: '脱落，掉下', conjugations: { dictionary: 'とれる', masu: 'とれます', te: 'とれて', nai: 'とれない', ta: 'とれた' }, sentences: [{ ja: 'ボタンがとれそうです。', zh: '纽扣快掉了。' }] },
    { id: 'L43-W7', category: 'Verbs', grammarType: 'Group II', kanji: '落ちます', kana: 'おちます', romaji: 'ochimasu', meaning: '掉落，落下', conjugations: { dictionary: '落ちる', masu: 'おちます', te: '落ちて', nai: '落ちない', ta: '落ちた' }, sentences: [{ ja: '今にも雨が落ちてきそうです。', zh: '看起来马上要下雨了。' }] },
    { id: 'L43-W8', category: 'Verbs', grammarType: 'Group I', kanji: 'なくなります', kana: 'なくなります', romaji: 'nakunarimasu', meaning: '没有了，用完', conjugations: { dictionary: 'なくなる', masu: 'なくなります', te: 'なくなって', nai: 'なくならない', ta: 'なくなった' }, sentences: [{ ja: 'ガソリンがなくなりそうです。', zh: '汽油快没了。' }] },
    { id: 'L43-W9', category: 'Adjectives', grammarType: 'na-adj', kanji: '変', kana: 'へん', romaji: 'hen', meaning: '奇怪', sentences: [{ ja: 'この機械は変な音がします。', zh: '这台机器发出奇怪的声音。' }] },
    { id: 'L43-W10', category: 'Adjectives', grammarType: 'na-adj', kanji: '幸せ', kana: 'しあわせ', romaji: 'shiawase', meaning: '幸福', sentences: [{ ja: '二人は幸せそうです。', zh: '两个人看起来很幸福。' }] },
    { id: 'L43-W11', category: 'Adjectives', grammarType: 'i-adj', kanji: 'うまい', kana: 'うまい', romaji: 'umai', meaning: '好吃；高明', sentences: [{ ja: 'このケーキはうまそうです。', zh: '这个蛋糕看起来很好吃。' }] },
    { id: 'L43-W12', category: 'Adjectives', grammarType: 'i-adj', kanji: 'まずい', kana: 'まずい', romaji: 'mazui', meaning: '难吃；糟糕', sentences: [{ ja: 'この料理はまずそうです。', zh: '这道菜看起来不好吃。' }] },
    { id: 'L43-W13', category: 'Adjectives', grammarType: 'i-adj', kanji: 'つまらない', kana: 'つまらない', romaji: 'tsumaranai', meaning: '无聊', sentences: [{ ja: 'この映画はつまらなそうです。', zh: '这部电影看起来很无聊。' }] },
    { id: 'L43-W14', category: 'Nouns', kanji: 'ガソリン', kana: 'ガソリン', romaji: 'gasorin', meaning: '汽油', sentences: [{ ja: 'ガソリンがなくなりそうです。', zh: '汽油快没了。' }] },
    { id: 'L43-W15', category: 'Nouns', kanji: '火', kana: 'ひ', romaji: 'hi', meaning: '火', sentences: [{ ja: '火が消えそうです。', zh: '火快灭了。' }] },
    { id: 'L43-W16', category: 'Nouns', kanji: 'パンフレット', kana: 'パンフレット', romaji: 'panfuretto', meaning: '宣传册', sentences: [{ ja: 'パンフレットをもらいました。', zh: '拿到了宣传册。' }] },
    { id: 'L43-W17', category: 'Adverbs', kanji: '今にも', kana: 'いまにも', romaji: 'ima ni mo', meaning: '眼看就要，马上', sentences: [{ ja: '今にも雨が降りそうです。', zh: '眼看就要下雨了。' }] },
    { id: 'L43-W18', category: 'Expressions', kanji: 'わあ', kana: 'わあ', romaji: 'waa', meaning: '哇', sentences: [{ ja: 'わあ、おいしそうですね。', zh: '哇，看起来很好吃。' }] },
    { id: 'L43-W19', category: 'Nouns', kanji: '会員', kana: 'かいいん', romaji: 'kaiin', meaning: '会员', sentences: [{ ja: '会員を募集しています。', zh: '正在招募会员。' }] },
    { id: 'L43-W20', category: 'Adjectives', grammarType: 'na-adj', kanji: '適当', kana: 'てきとう', romaji: 'tekitou', meaning: '合适，适当', sentences: [{ ja: '適当な人を紹介してください。', zh: '请介绍合适的人。' }] },
    { id: 'L43-W21', category: 'Nouns', kanji: '年齢', kana: 'ねんれい', romaji: 'nenrei', meaning: '年龄', sentences: [{ ja: '年齢を書いてください。', zh: '请写年龄。' }] },
    { id: 'L43-W22', category: 'Nouns', kanji: '収入', kana: 'しゅうにゅう', romaji: 'shuunyuu', meaning: '收入', sentences: [{ ja: '収入が増えました。', zh: '收入增加了。' }] },
    { id: 'L43-W23', category: 'Adverbs', kanji: 'ぴったり', kana: 'ぴったり', romaji: 'pittari', meaning: '正合适', sentences: [{ ja: 'この仕事はあなたにぴったりです。', zh: '这份工作正适合你。' }] }
  ],
  44: [
    { id: 'L44-W1', category: 'Verbs', grammarType: 'Group I', kanji: '泣きます', kana: 'なきます', romaji: 'nakimasu', meaning: '哭', conjugations: { dictionary: '泣く', masu: 'なきます', te: '泣いて', nai: '泣かない', ta: '泣いた' }, sentences: [{ ja: '子どもが泣いています。', zh: '孩子正在哭。' }] },
    { id: 'L44-W2', category: 'Verbs', grammarType: 'Group I', kanji: '笑います', kana: 'わらいます', romaji: 'waraimasu', meaning: '笑', conjugations: { dictionary: '笑う', masu: 'わらいます', te: '笑って', nai: '笑わない', ta: '笑った' }, sentences: [{ ja: 'みんなが笑いました。', zh: '大家都笑了。' }] },
    { id: 'L44-W3', category: 'Verbs', grammarType: 'Group I', kanji: '乾きます', kana: 'かわきます', romaji: 'kawakimasu', meaning: '干，干燥', conjugations: { dictionary: '乾く', masu: 'かわきます', te: '乾いて', nai: '乾かない', ta: '乾いた' }, sentences: [{ ja: '洗濯物が乾きました。', zh: '洗的衣服干了。' }] },
    { id: 'L44-W4', category: 'Verbs', grammarType: 'Group II', kanji: 'ぬれます', kana: 'ぬれます', romaji: 'nuremasu', meaning: '湿，淋湿', conjugations: { dictionary: 'ぬれる', masu: 'ぬれます', te: 'ぬれて', nai: 'ぬれない', ta: 'ぬれた' }, sentences: [{ ja: '雨で服がぬれました。', zh: '衣服被雨淋湿了。' }] },
    { id: 'L44-W5', category: 'Verbs', grammarType: 'Group I', kanji: '滑ります', kana: 'すべります', romaji: 'suberimasu', meaning: '滑', conjugations: { dictionary: '滑る', masu: 'すべります', te: '滑って', nai: '滑らない', ta: '滑った' }, sentences: [{ ja: '道が滑りやすいです。', zh: '路很容易滑。' }] },
    { id: 'L44-W6', category: 'Verbs', grammarType: 'Group II', kanji: '起きます', kana: 'おきます', romaji: 'okimasu', meaning: '发生（事故等）', conjugations: { dictionary: '起きる', masu: 'おきます', te: '起きて', nai: '起きない', ta: '起きた' }, sentences: [{ ja: '交差点で事故が起きました。', zh: '十字路口发生了事故。' }] },
    { id: 'L44-W7', category: 'Verbs', grammarType: 'Irregular', kanji: '調節します', kana: 'ちょうせつします', romaji: 'chousetsu shimasu', meaning: '调节', conjugations: { dictionary: '調節する', masu: 'ちょうせつします', te: '調節して', nai: '調節しない', ta: '調節した' }, sentences: [{ ja: 'エアコンの温度を調節します。', zh: '调节空调温度。' }] },
    { id: 'L44-W8', category: 'Adjectives', grammarType: 'na-adj', kanji: '安全', kana: 'あんぜん', romaji: 'anzen', meaning: '安全', sentences: [{ ja: 'この道は安全です。', zh: '这条路很安全。' }] },
    { id: 'L44-W9', category: 'Adjectives', grammarType: 'na-adj', kanji: '丁寧', kana: 'ていねい', romaji: 'teinei', meaning: '礼貌，细致', sentences: [{ ja: '丁寧に説明してください。', zh: '请仔细说明。' }] },
    { id: 'L44-W10', category: 'Adjectives', grammarType: 'i-adj', kanji: '細かい', kana: 'こまかい', romaji: 'komakai', meaning: '细小，细致', sentences: [{ ja: '字が細かすぎて、読みにくいです。', zh: '字太小，很难读。' }] },
    { id: 'L44-W11', category: 'Adjectives', grammarType: 'i-adj', kanji: '濃い', kana: 'こい', romaji: 'koi', meaning: '浓，深', sentences: [{ ja: 'このコーヒーは濃すぎます。', zh: '这咖啡太浓了。' }] },
    { id: 'L44-W12', category: 'Adjectives', grammarType: 'i-adj', kanji: '薄い', kana: 'うすい', romaji: 'usui', meaning: '淡，薄', sentences: [{ ja: '味が薄いです。', zh: '味道淡。' }] },
    { id: 'L44-W13', category: 'Nouns', kanji: '空気', kana: 'くうき', romaji: 'kuuki', meaning: '空气', sentences: [{ ja: '空気がきれいです。', zh: '空气很干净。' }] },
    { id: 'L44-W14', category: 'Nouns', kanji: '涙', kana: 'なみだ', romaji: 'namida', meaning: '眼泪', sentences: [{ ja: '涙が出ました。', zh: '流出了眼泪。' }] },
    { id: 'L44-W15', category: 'Nouns', kanji: '和食', kana: 'わしょく', romaji: 'washoku', meaning: '日式饭菜', sentences: [{ ja: '和食にします。', zh: '选日式饭菜。' }] },
    { id: 'L44-W16', category: 'Nouns', kanji: '洋食', kana: 'ようしょく', romaji: 'youshoku', meaning: '西式饭菜', sentences: [{ ja: '洋食もあります。', zh: '也有西式饭菜。' }] },
    { id: 'L44-W17', category: 'Nouns', kanji: 'おかず', kana: 'おかず', romaji: 'okazu', meaning: '菜，配菜', sentences: [{ ja: 'おかずの量を半分にします。', zh: '把配菜分量减半。' }] },
    { id: 'L44-W18', category: 'Nouns', kanji: '量', kana: 'りょう', romaji: 'ryou', meaning: '量，分量', sentences: [{ ja: '量が多すぎます。', zh: '分量太多。' }] },
    { id: 'L44-W19', category: 'Nouns', kanji: '倍', kana: 'ばい', romaji: 'bai', meaning: '倍', sentences: [{ ja: '値段は去年の倍です。', zh: '价格是去年的两倍。' }] },
    { id: 'L44-W20', category: 'Nouns', kanji: '半分', kana: 'はんぶん', romaji: 'hanbun', meaning: '一半', sentences: [{ ja: '砂糖を半分にしてください。', zh: '请把糖减半。' }] },
    { id: 'L44-W21', category: 'Nouns', kanji: 'シングル', kana: 'シングル', romaji: 'shinguru', meaning: '单人间', sentences: [{ ja: 'シングルの部屋を予約しました。', zh: '预订了单人间。' }] },
    { id: 'L44-W22', category: 'Nouns', kanji: 'ツイン', kana: 'ツイン', romaji: 'tsuin', meaning: '双人间', sentences: [{ ja: 'ツインにしてください。', zh: '请安排双人间。' }] },
    { id: 'L44-W23', category: 'Expressions', kanji: 'どうなさいますか', kana: 'どうなさいますか', romaji: 'dou nasaimasu ka', meaning: '您要怎么办，您选择什么', sentences: [{ ja: 'お部屋はどうなさいますか。', zh: '房间您要怎么安排？' }] }
  ],
  45: [
    { id: 'L45-W1', category: 'Verbs', grammarType: 'Group I', kanji: '謝ります', kana: 'あやまります', romaji: 'ayamarimasu', meaning: '道歉', conjugations: { dictionary: '謝る', masu: 'あやまります', te: '謝って', nai: '謝らない', ta: '謝った' }, sentences: [{ ja: '友達に謝りました。', zh: '向朋友道歉了。' }] },
    { id: 'L45-W2', category: 'Verbs', grammarType: 'Group II', kanji: '信じます', kana: 'しんじます', romaji: 'shinjimasu', meaning: '相信', conjugations: { dictionary: '信じる', masu: 'しんじます', te: '信じて', nai: '信じない', ta: '信じた' }, sentences: [{ ja: '先生の言葉を信じます。', zh: '相信老师的话。' }] },
    { id: 'L45-W3', category: 'Verbs', grammarType: 'Irregular', kanji: '用意します', kana: 'よういします', romaji: 'youi shimasu', meaning: '准备', conjugations: { dictionary: '用意する', masu: 'よういします', te: '用意して', nai: '用意しない', ta: '用意した' }, sentences: [{ ja: '資料を用意します。', zh: '准备资料。' }] },
    { id: 'L45-W4', category: 'Verbs', grammarType: 'Irregular', kanji: 'キャンセルします', kana: 'キャンセルします', romaji: 'kyanseru shimasu', meaning: '取消', conjugations: { dictionary: 'キャンセルする', masu: 'キャンセルします', te: 'キャンセルして', nai: 'キャンセルしない', ta: 'キャンセルした' }, sentences: [{ ja: '予約をキャンセルします。', zh: '取消预约。' }] },
    { id: 'L45-W5', category: 'Verbs', grammarType: 'Group I', kanji: 'うまくいきます', kana: 'うまくいきます', romaji: 'umaku ikimasu', meaning: '顺利进行', conjugations: { dictionary: 'うまくいく', masu: 'うまくいきます', te: 'うまくいって', nai: 'うまくいかない', ta: 'うまくいった' }, sentences: [{ ja: '仕事がうまくいきました。', zh: '工作顺利进行了。' }] },
    { id: 'L45-W6', category: 'Nouns', kanji: '保証書', kana: 'ほしょうしょ', romaji: 'hoshousho', meaning: '保证书，保修单', sentences: [{ ja: '保証書を見せてください。', zh: '请给我看保修单。' }] },
    { id: 'L45-W7', category: 'Nouns', kanji: '領収書', kana: 'りょうしゅうしょ', romaji: 'ryoushuusho', meaning: '收据', sentences: [{ ja: '領収書をお願いします。', zh: '请给我收据。' }] },
    { id: 'L45-W8', category: 'Nouns', kanji: 'キャンプ', kana: 'キャンプ', romaji: 'kyanpu', meaning: '露营', sentences: [{ ja: '雨の場合はキャンプを中止します。', zh: '下雨时取消露营。' }] },
    { id: 'L45-W9', category: 'Nouns', kanji: '係', kana: 'かかり', romaji: 'kakari', meaning: '负责人，工作人员', sentences: [{ ja: '係の人に聞いてください。', zh: '请问负责人。' }] },
    { id: 'L45-W10', category: 'Nouns', kanji: '中止', kana: 'ちゅうし', romaji: 'chuushi', meaning: '中止，取消', sentences: [{ ja: '試合は雨で中止になりました。', zh: '比赛因雨取消了。' }] },
    { id: 'L45-W11', category: 'Nouns', kanji: '点', kana: 'てん', romaji: 'ten', meaning: '分数，点', sentences: [{ ja: '試験で100点を取りました。', zh: '考试得了100分。' }] },
    { id: 'L45-W12', category: 'Nouns', kanji: 'レバー', kana: 'レバー', romaji: 'rebaa', meaning: '杆，操纵杆', sentences: [{ ja: 'レバーを押してください。', zh: '请按操纵杆。' }] },
    { id: 'L45-W13', category: 'Nouns', kanji: '丸', kana: 'まる', romaji: 'maru', meaning: '圆圈', sentences: [{ ja: '正しい答えに丸をつけます。', zh: '在正确答案上画圈。' }] },
    { id: 'L45-W14', category: 'Adverbs', kanji: '急に', kana: 'きゅうに', romaji: 'kyuu ni', meaning: '突然', sentences: [{ ja: '急に雨が降りました。', zh: '突然下雨了。' }] },
    { id: 'L45-W15', category: 'Adverbs', kanji: '楽しみに', kana: 'たのしみに', romaji: 'tanoshimi ni', meaning: '期待地', sentences: [{ ja: '旅行を楽しみにしています。', zh: '期待旅行。' }] },
    { id: 'L45-W16', category: 'Expressions', kanji: '以上です', kana: 'いじょうです', romaji: 'ijou desu', meaning: '以上，到此为止', sentences: [{ ja: '説明は以上です。', zh: '说明到此为止。' }] }
  ],
  46: [
    { id: 'L46-W1', category: 'Verbs', grammarType: 'Group I', kanji: '渡します', kana: 'わたします', romaji: 'watashimasu', meaning: '交给，递给', conjugations: { dictionary: '渡す', masu: 'わたします', te: '渡して', nai: '渡さない', ta: '渡した' }, sentences: [{ ja: '書類を受付に渡します。', zh: '把文件交给前台。' }] },
    { id: 'L46-W2', category: 'Verbs', grammarType: 'Irregular', kanji: '帰って来ます', kana: 'かえってきます', romaji: 'kaette kimasu', meaning: '回来', conjugations: { dictionary: '帰って来る', masu: 'かえってきます', te: '帰って来て', nai: '帰って来ない', ta: '帰って来た' }, sentences: [{ ja: '子どもは今帰って来たところです。', zh: '孩子刚刚回来。' }] },
    { id: 'L46-W3', category: 'Verbs', grammarType: 'Group II', kanji: '出ます', kana: 'でます', romaji: 'demasu', meaning: '出发，开出', conjugations: { dictionary: '出る', masu: 'でます', te: '出て', nai: '出ない', ta: '出た' }, sentences: [{ ja: 'バスは出たばかりです。', zh: '公交刚开走。' }] },
    { id: 'L46-W4', category: 'Verbs', grammarType: 'Group I', kanji: '届きます', kana: 'とどきます', romaji: 'todokimasu', meaning: '送到，到达', conjugations: { dictionary: '届く', masu: 'とどきます', te: '届いて', nai: '届かない', ta: '届いた' }, sentences: [{ ja: '荷物はもうすぐ届くはずです。', zh: '行李应该马上送到。' }] },
    { id: 'L46-W5', category: 'Verbs', grammarType: 'Irregular', kanji: '入学します', kana: 'にゅうがくします', romaji: 'nyuugaku shimasu', meaning: '入学', conjugations: { dictionary: '入学する', masu: 'にゅうがくします', te: '入学して', nai: '入学しない', ta: '入学した' }, sentences: [{ ja: '弟は大学に入学したばかりです。', zh: '弟弟刚进大学。' }] },
    { id: 'L46-W6', category: 'Verbs', grammarType: 'Irregular', kanji: '卒業します', kana: 'そつぎょうします', romaji: 'sotsugyou shimasu', meaning: '毕业', conjugations: { dictionary: '卒業する', masu: 'そつぎょうします', te: '卒業して', nai: '卒業しない', ta: '卒業した' }, sentences: [{ ja: '姉は大学を卒業したばかりです。', zh: '姐姐刚大学毕业。' }] },
    { id: 'L46-W7', category: 'Verbs', grammarType: 'Group I', kanji: '焼きます', kana: 'やきます', romaji: 'yakimasu', meaning: '烤，烧', conjugations: { dictionary: '焼く', masu: 'やきます', te: '焼いて', nai: '焼かない', ta: '焼いた' }, sentences: [{ ja: 'パンを焼いたところです。', zh: '刚烤好面包。' }] },
    { id: 'L46-W8', category: 'Nouns', kanji: '留守', kana: 'るす', romaji: 'rusu', meaning: '不在家', sentences: [{ ja: '今、田中さんは留守です。', zh: '田中先生现在不在家。' }] },
    { id: 'L46-W9', category: 'Nouns', kanji: '宅配便', kana: 'たくはいびん', romaji: 'takuhaibin', meaning: '快递', sentences: [{ ja: '宅配便が届きました。', zh: '快递到了。' }] },
    { id: 'L46-W10', category: 'Nouns', kanji: '原因', kana: 'げんいん', romaji: 'genin', meaning: '原因', sentences: [{ ja: '事故の原因を調べます。', zh: '调查事故原因。' }] },
    { id: 'L46-W11', category: 'Nouns', kanji: '注射', kana: 'ちゅうしゃ', romaji: 'chuusha', meaning: '注射', sentences: [{ ja: '注射をします。', zh: '打针。' }] },
    { id: 'L46-W12', category: 'Nouns', kanji: '食欲', kana: 'しょくよく', romaji: 'shokuyoku', meaning: '食欲', sentences: [{ ja: '今日は食欲がありません。', zh: '今天没有食欲。' }] },
    { id: 'L46-W13', category: 'Nouns', kanji: 'ガスレンジ', kana: 'ガスレンジ', romaji: 'gasu renji', meaning: '燃气灶', sentences: [{ ja: 'ガスレンジの火がつきません。', zh: '燃气灶打不着火。' }] },
    { id: 'L46-W14', category: 'Nouns', kanji: 'ガスサービスセンター', kana: 'ガスサービスセンター', romaji: 'gasu saabisu sentaa', meaning: '燃气服务中心', sentences: [{ ja: 'ガスサービスセンターに電話します。', zh: '给燃气服务中心打电话。' }] },
    { id: 'L46-W15', category: 'Nouns', kanji: '具合', kana: 'ぐあい', romaji: 'guai', meaning: '情况，状态', sentences: [{ ja: '体の具合が悪いです。', zh: '身体状况不好。' }] },
    { id: 'L46-W16', category: 'Expressions', kanji: 'たった今', kana: 'たったいま', romaji: 'tatta ima', meaning: '刚刚', sentences: [{ ja: 'たった今帰って来たところです。', zh: '刚刚回来。' }] },
    { id: 'L46-W17', category: 'Expressions', kanji: 'ところです', kana: 'ところです', romaji: 'tokoro desu', meaning: '正要/正在/刚刚做', sentences: [{ ja: '今から出かけるところです。', zh: '现在正要出门。' }] },
    { id: 'L46-W18', category: 'Expressions', kanji: 'ばかりです', kana: 'ばかりです', romaji: 'bakari desu', meaning: '刚刚……', sentences: [{ ja: '昼ご飯を食べたばかりです。', zh: '刚吃过午饭。' }] }
  ],
  47: [
    { id: 'L47-W1', category: 'Verbs', grammarType: 'Group I', kanji: '集まります', kana: 'あつまります', romaji: 'atsumarimasu', meaning: '集合，聚集', conjugations: { dictionary: '集まる', masu: 'あつまります', te: '集まって', nai: '集まらない', ta: '集まった' }, sentences: [{ ja: '駅前に人が集まっています。', zh: '车站前聚集着人。' }] },
    { id: 'L47-W2', category: 'Verbs', grammarType: 'Group II', kanji: '別れます', kana: 'わかれます', romaji: 'wakaremasu', meaning: '分手，分别', conjugations: { dictionary: '別れる', masu: 'わかれます', te: '別れて', nai: '別れない', ta: '別れた' }, sentences: [{ ja: '駅で友達と別れました。', zh: '在车站和朋友分别。' }] },
    { id: 'L47-W3', category: 'Verbs', grammarType: 'Irregular', kanji: '長生きします', kana: 'ながいきします', romaji: 'nagaiki shimasu', meaning: '长寿', conjugations: { dictionary: '長生きする', masu: 'ながいきします', te: '長生きして', nai: '長生きしない', ta: '長生きした' }, sentences: [{ ja: '日本人は長生きするそうです。', zh: '听说日本人长寿。' }] },
    { id: 'L47-W4', category: 'Verbs', grammarType: 'Irregular', kanji: '音がします', kana: 'おとがします', romaji: 'oto ga shimasu', meaning: '有声音', conjugations: { dictionary: '音がする', masu: 'おとがします', te: '音がして', nai: '音がしない', ta: '音がした' }, sentences: [{ ja: '隣の部屋から変な音がします。', zh: '隔壁房间传来奇怪的声音。' }] },
    { id: 'L47-W5', category: 'Verbs', grammarType: 'Irregular', kanji: '味がします', kana: 'あじがします', romaji: 'aji ga shimasu', meaning: '有味道', conjugations: { dictionary: '味がする', masu: 'あじがします', te: '味がして', nai: '味がしない', ta: '味がした' }, sentences: [{ ja: 'この水は変な味がします。', zh: '这水有奇怪的味道。' }] },
    { id: 'L47-W6', category: 'Verbs', grammarType: 'Irregular', kanji: '匂いがします', kana: 'においがします', romaji: 'nioi ga shimasu', meaning: '有气味', conjugations: { dictionary: '匂いがする', masu: 'においがします', te: '匂いがして', nai: '匂いがしない', ta: '匂いがした' }, sentences: [{ ja: '台所からいい匂いがします。', zh: '厨房传来好闻的味道。' }] },
    { id: 'L47-W7', category: 'Verbs', grammarType: 'Group I', kanji: 'さします', kana: 'さします', romaji: 'sashimasu', meaning: '撑（伞）', conjugations: { dictionary: 'さす', masu: 'さします', te: 'さして', nai: 'ささない', ta: 'さした' }, sentences: [{ ja: '雨が降っているので、傘をさします。', zh: '因为下雨，所以撑伞。' }] },
    { id: 'L47-W8', category: 'Adjectives', grammarType: 'i-adj', kanji: 'ひどい', kana: 'ひどい', romaji: 'hidoi', meaning: '严重，厉害', sentences: [{ ja: 'ひどい雨ですね。', zh: '雨真大啊。' }] },
    { id: 'L47-W9', category: 'Adjectives', grammarType: 'i-adj', kanji: '怖い', kana: 'こわい', romaji: 'kowai', meaning: '可怕', sentences: [{ ja: '地震は怖いです。', zh: '地震很可怕。' }] },
    { id: 'L47-W10', category: 'Nouns', kanji: '天気予報', kana: 'てんきよほう', romaji: 'tenki yohou', meaning: '天气预报', sentences: [{ ja: '天気予報によると、明日は雨だそうです。', zh: '据天气预报说明天会下雨。' }] },
    { id: 'L47-W11', category: 'Nouns', kanji: '発表', kana: 'はっぴょう', romaji: 'happyou', meaning: '发表，发布', sentences: [{ ja: '研究の発表を聞きました。', zh: '听了研究发表。' }] },
    { id: 'L47-W12', category: 'Nouns', kanji: '実験', kana: 'じっけん', romaji: 'jikken', meaning: '实验', sentences: [{ ja: '実験は成功したそうです。', zh: '听说实验成功了。' }] },
    { id: 'L47-W13', category: 'Nouns', kanji: '人口', kana: 'じんこう', romaji: 'jinkou', meaning: '人口', sentences: [{ ja: 'この町の人口は減っているそうです。', zh: '听说这个城市的人口正在减少。' }] },
    { id: 'L47-W14', category: 'Nouns', kanji: '科学', kana: 'かがく', romaji: 'kagaku', meaning: '科学', sentences: [{ ja: '科学の本を読みます。', zh: '读科学书。' }] },
    { id: 'L47-W15', category: 'Nouns', kanji: '医学', kana: 'いがく', romaji: 'igaku', meaning: '医学', sentences: [{ ja: '医学を勉強しています。', zh: '正在学习医学。' }] },
    { id: 'L47-W16', category: 'Nouns', kanji: '文学', kana: 'ぶんがく', romaji: 'bungaku', meaning: '文学', sentences: [{ ja: '日本文学に興味があります。', zh: '对日本文学感兴趣。' }] },
    { id: 'L47-W17', category: 'Nouns', kanji: 'パトカー', kana: 'パトカー', romaji: 'patokaa', meaning: '警车', sentences: [{ ja: 'パトカーの音がします。', zh: '有警车的声音。' }] },
    { id: 'L47-W18', category: 'Nouns', kanji: '救急車', kana: 'きゅうきゅうしゃ', romaji: 'kyuukyuusha', meaning: '救护车', sentences: [{ ja: '救急車を呼んでください。', zh: '请叫救护车。' }] },
    { id: 'L47-W19', category: 'Nouns', kanji: '賛成', kana: 'さんせい', romaji: 'sansei', meaning: '赞成', sentences: [{ ja: 'わたしはその意見に賛成です。', zh: '我赞成那个意见。' }] },
    { id: 'L47-W20', category: 'Nouns', kanji: '反対', kana: 'はんたい', romaji: 'hantai', meaning: '反对', sentences: [{ ja: '父は留学に反対です。', zh: '父亲反对留学。' }] },
    { id: 'L47-W21', category: 'Adverbs', kanji: 'どうも', kana: 'どうも', romaji: 'doumo', meaning: '总觉得，好像', sentences: [{ ja: 'どうも変な音がします。', zh: '总觉得有奇怪的声音。' }] }
  ],
  48: [
    { id: 'L48-W1', category: 'Verbs', grammarType: 'Group I', kanji: '降ろします', kana: 'おろします', romaji: 'oroshimasu', meaning: '放下，让下车', conjugations: { dictionary: '降ろす', masu: 'おろします', te: '降ろして', nai: '降ろさない', ta: '降ろした' }, sentences: [{ ja: 'ここで降ろしてください。', zh: '请让我在这里下车。' }] },
    { id: 'L48-W2', category: 'Verbs', grammarType: 'Group II', kanji: '届けます', kana: 'とどけます', romaji: 'todokemasu', meaning: '送到，递送', conjugations: { dictionary: '届ける', masu: 'とどけます', te: '届けて', nai: '届けない', ta: '届けた' }, sentences: [{ ja: '荷物を家まで届けます。', zh: '把行李送到家。' }] },
    { id: 'L48-W3', category: 'Verbs', grammarType: 'Irregular', kanji: '世話をします', kana: 'せわをします', romaji: 'sewa o shimasu', meaning: '照顾', conjugations: { dictionary: '世話をする', masu: 'せわをします', te: '世話をして', nai: '世話をしない', ta: '世話をした' }, sentences: [{ ja: '子どもの世話をします。', zh: '照顾孩子。' }] },
    { id: 'L48-W4', category: 'Verbs', grammarType: 'Irregular', kanji: '録音します', kana: 'ろくおんします', romaji: 'rokuon shimasu', meaning: '录音', conjugations: { dictionary: '録音する', masu: 'ろくおんします', te: '録音して', nai: '録音しない', ta: '録音した' }, sentences: [{ ja: '会話を録音します。', zh: '录下会话。' }] },
    { id: 'L48-W5', category: 'Verbs', grammarType: 'Group I', kanji: '楽しみます', kana: 'たのしみます', romaji: 'tanoshimimasu', meaning: '享受，玩得开心', conjugations: { dictionary: '楽しむ', masu: 'たのしみます', te: '楽しんで', nai: '楽しまない', ta: '楽しんだ' }, sentences: [{ ja: '週末を楽しみます。', zh: '享受周末。' }] },
    { id: 'L48-W6', category: 'Adjectives', grammarType: 'na-adj', kanji: '嫌', kana: 'いや', romaji: 'iya', meaning: '讨厌，不愿意', sentences: [{ ja: '嫌なことを無理にさせません。', zh: '不强迫做讨厌的事。' }] },
    { id: 'L48-W7', category: 'Adjectives', grammarType: 'i-adj', kanji: '厳しい', kana: 'きびしい', romaji: 'kibishii', meaning: '严格', sentences: [{ ja: '先生は厳しいです。', zh: '老师很严格。' }] },
    { id: 'L48-W8', category: 'Nouns', kanji: '塾', kana: 'じゅく', romaji: 'juku', meaning: '补习班', sentences: [{ ja: '子どもを塾へ行かせます。', zh: '让孩子去补习班。' }] },
    { id: 'L48-W9', category: 'Nouns', kanji: '生徒', kana: 'せいと', romaji: 'seito', meaning: '学生', sentences: [{ ja: '先生は生徒に作文を書かせます。', zh: '老师让学生写作文。' }] },
    { id: 'L48-W10', category: 'Nouns', kanji: 'ファイル', kana: 'ファイル', romaji: 'fairu', meaning: '文件，文件夹', sentences: [{ ja: 'ファイルを送ってください。', zh: '请发送文件。' }] },
    { id: 'L48-W11', category: 'Nouns', kanji: '営業', kana: 'えいぎょう', romaji: 'eigyou', meaning: '营业，销售', sentences: [{ ja: '営業の仕事をしています。', zh: '从事销售工作。' }] },
    { id: 'L48-W12', category: 'Nouns', kanji: '予定', kana: 'よてい', romaji: 'yotei', meaning: '计划，安排', sentences: [{ ja: '予定を確認します。', zh: '确认安排。' }] },
    { id: 'L48-W13', category: 'Adverbs', kanji: '自由に', kana: 'じゆうに', romaji: 'jiyuu ni', meaning: '自由地', sentences: [{ ja: '子どもに自由に遊ばせます。', zh: '让孩子自由玩耍。' }] },
    { id: 'L48-W14', category: 'Expressions', kanji: 'いいことですね', kana: 'いいことですね', romaji: 'ii koto desu ne', meaning: '真是好事啊', sentences: [{ ja: '子どもにいろいろな経験をさせるのはいいことですね。', zh: '让孩子有各种体验是好事啊。' }] }
  ],
  49: [
    { id: 'L49-W1', category: 'Verbs', grammarType: 'Irregular', kanji: '利用します', kana: 'りようします', romaji: 'riyou shimasu', meaning: '利用，使用', conjugations: { dictionary: '利用する', masu: 'りようします', te: '利用して', nai: '利用しない', ta: '利用した' }, sentences: [{ ja: 'このカードはどなたでも利用できます。', zh: '这张卡任何人都能使用。' }] },
    { id: 'L49-W2', category: 'Verbs', grammarType: 'Group II', kanji: '勤めます', kana: 'つとめます', romaji: 'tsutomemasu', meaning: '工作，任职', conjugations: { dictionary: '勤める', masu: 'つとめます', te: '勤めて', nai: '勤めない', ta: '勤めた' }, sentences: [{ ja: '父は銀行に勤めています。', zh: '父亲在银行工作。' }] },
    { id: 'L49-W3', category: 'Verbs', grammarType: 'Group II', kanji: '掛けます', kana: 'かけます', romaji: 'kakemasu', meaning: '坐（椅子）', conjugations: { dictionary: '掛ける', masu: 'かけます', te: '掛けて', nai: '掛けない', ta: '掛けた' }, sentences: [{ ja: 'こちらにお掛けください。', zh: '请坐这边。' }] },
    { id: 'L49-W4', category: 'Verbs', grammarType: 'Group I', kanji: '過ごします', kana: 'すごします', romaji: 'sugoshimasu', meaning: '度过', conjugations: { dictionary: '過ごす', masu: 'すごします', te: '過ごして', nai: '過ごさない', ta: '過ごした' }, sentences: [{ ja: '週末は家で過ごしました。', zh: '周末在家度过了。' }] },
    { id: 'L49-W5', category: 'Verbs', grammarType: 'Group I', kanji: 'いらっしゃいます', kana: 'いらっしゃいます', romaji: 'irasshaimasu', meaning: '在，来，去（尊敬语）', conjugations: { dictionary: 'いらっしゃる', masu: 'いらっしゃいます', te: 'いらっしゃって', nai: 'いらっしゃらない', ta: 'いらっしゃった' }, sentences: [{ ja: '先生は研究室にいらっしゃいます。', zh: '老师在研究室。' }] },
    { id: 'L49-W6', category: 'Verbs', grammarType: 'Group I', kanji: '召し上がります', kana: 'めしあがります', romaji: 'meshiagarimasu', meaning: '吃，喝（尊敬语）', conjugations: { dictionary: '召し上がる', masu: 'めしあがります', te: '召し上がって', nai: '召し上がらない', ta: '召し上がった' }, sentences: [{ ja: '先生は何を召し上がりますか。', zh: '老师您吃什么？' }] },
    { id: 'L49-W7', category: 'Verbs', grammarType: 'Group I', kanji: 'おっしゃいます', kana: 'おっしゃいます', romaji: 'osshaimasu', meaning: '说（尊敬语）', conjugations: { dictionary: 'おっしゃる', masu: 'おっしゃいます', te: 'おっしゃって', nai: 'おっしゃらない', ta: 'おっしゃった' }, sentences: [{ ja: '先生はそうおっしゃいました。', zh: '老师那样说了。' }] },
    { id: 'L49-W8', category: 'Verbs', grammarType: 'Group I', kanji: 'なさいます', kana: 'なさいます', romaji: 'nasaimasu', meaning: '做（尊敬语）', conjugations: { dictionary: 'なさる', masu: 'なさいます', te: 'なさって', nai: 'なさらない', ta: 'なさった' }, sentences: [{ ja: '部長はゴルフをなさいます。', zh: '部长打高尔夫。' }] },
    { id: 'L49-W9', category: 'Verbs', grammarType: 'Group II', kanji: 'ご覧になります', kana: 'ごらんになります', romaji: 'goran ni narimasu', meaning: '看（尊敬语）', conjugations: { dictionary: 'ご覧になる', masu: 'ごらんになります', te: 'ご覧になって', nai: 'ご覧にならない', ta: 'ご覧になった' }, sentences: [{ ja: 'この資料をご覧ください。', zh: '请看这份资料。' }] },
    { id: 'L49-W10', category: 'Expressions', kanji: 'ご存じです', kana: 'ごぞんじです', romaji: 'gozonji desu', meaning: '知道（尊敬语）', sentences: [{ ja: '先生はこのニュースをご存じです。', zh: '老师知道这条新闻。' }] },
    { id: 'L49-W11', category: 'Nouns', kanji: '挨拶', kana: 'あいさつ', romaji: 'aisatsu', meaning: '寒暄，致辞', sentences: [{ ja: '社長が挨拶なさいました。', zh: '社长致辞了。' }] },
    { id: 'L49-W12', category: 'Nouns', kanji: '旅館', kana: 'りょかん', romaji: 'ryokan', meaning: '日式旅馆', sentences: [{ ja: '京都の旅館に泊まりました。', zh: '住在京都的日式旅馆。' }] },
    { id: 'L49-W13', category: 'Nouns', kanji: 'バス停', kana: 'バスてい', romaji: 'basutei', meaning: '公交车站', sentences: [{ ja: 'バス停はどちらですか。', zh: '公交车站在哪里？' }] },
    { id: 'L49-W14', category: 'Nouns', kanji: '奥様', kana: 'おくさま', romaji: 'okusama', meaning: '夫人，太太（尊称）', sentences: [{ ja: '奥様もいらっしゃいますか。', zh: '您夫人也来吗？' }] },
    { id: 'L49-W15', category: 'Nouns', kanji: '帰り', kana: 'かえり', romaji: 'kaeri', meaning: '回去，归途', sentences: [{ ja: 'お帰りは何時ですか。', zh: '您几点回去？' }] },
    { id: 'L49-W16', category: 'Adverbs', kanji: 'たまに', kana: 'たまに', romaji: 'tama ni', meaning: '偶尔', sentences: [{ ja: 'たまに映画をご覧になります。', zh: '偶尔看电影。' }] },
    { id: 'L49-W17', category: 'Adverbs', kanji: 'ちっとも', kana: 'ちっとも', romaji: 'chitto mo', meaning: '一点也不（接否定）', sentences: [{ ja: 'ちっともわかりません。', zh: '一点也不懂。' }] },
    { id: 'L49-W18', category: 'Expressions', kanji: '遠慮なく', kana: 'えんりょなく', romaji: 'enryo naku', meaning: '不用客气', sentences: [{ ja: '遠慮なく召し上がってください。', zh: '请不用客气地吃。' }] }
  ],
  50: [
    { id: 'L50-W1', category: 'Verbs', grammarType: 'Group I', kanji: '参ります', kana: 'まいります', romaji: 'mairimasu', meaning: '去，来（謙譲語）', conjugations: { dictionary: '参る', masu: 'まいります', te: '参って', nai: '参らない', ta: '参った' }, sentences: [{ ja: '明日そちらへ参ります。', zh: '明天我去您那里。' }] },
    { id: 'L50-W2', category: 'Verbs', grammarType: 'Group I', kanji: 'おります', kana: 'おります', romaji: 'orimasu', meaning: '在（謙譲語）', conjugations: { dictionary: 'おる', masu: 'おります', te: 'おって', nai: 'おらない', ta: 'おった' }, sentences: [{ ja: '私は受付におります。', zh: '我在前台。' }] },
    { id: 'L50-W3', category: 'Verbs', grammarType: 'Group I', kanji: 'いただきます', kana: 'いただきます', romaji: 'itadakimasu', meaning: '吃，喝，得到（謙譲語）', conjugations: { dictionary: 'いただく', masu: 'いただきます', te: 'いただいて', nai: 'いただかない', ta: 'いただいた' }, sentences: [{ ja: 'お茶をいただきます。', zh: '我喝茶。' }] },
    { id: 'L50-W4', category: 'Verbs', grammarType: 'Group I', kanji: '申します', kana: 'もうします', romaji: 'moushimasu', meaning: '叫，说（謙譲語）', conjugations: { dictionary: '申す', masu: 'もうします', te: '申して', nai: '申さない', ta: '申した' }, sentences: [{ ja: 'ミラーと申します。', zh: '我叫米勒。' }] },
    { id: 'L50-W5', category: 'Verbs', grammarType: 'Irregular', kanji: 'いたします', kana: 'いたします', romaji: 'itashimasu', meaning: '做（謙譲語）', conjugations: { dictionary: 'いたす', masu: 'いたします', te: 'いたして', nai: 'いたさない', ta: 'いたした' }, sentences: [{ ja: '私が説明いたします。', zh: '由我来说明。' }] },
    { id: 'L50-W6', category: 'Verbs', grammarType: 'Irregular', kanji: '拝見します', kana: 'はいけんします', romaji: 'haiken shimasu', meaning: '看（謙譲語）', conjugations: { dictionary: '拝見する', masu: 'はいけんします', te: '拝見して', nai: '拝見しない', ta: '拝見した' }, sentences: [{ ja: '資料を拝見しました。', zh: '我拜读了资料。' }] },
    { id: 'L50-W7', category: 'Verbs', grammarType: 'Irregular', kanji: '存じます', kana: 'ぞんじます', romaji: 'zonjimasu', meaning: '知道，认为（謙譲語）', conjugations: { dictionary: '存じる', masu: 'ぞんじます', te: '存じて', nai: '存じない', ta: '存じた' }, sentences: [{ ja: 'その件は存じません。', zh: '那件事我不知道。' }] },
    { id: 'L50-W8', category: 'Verbs', grammarType: 'Group I', kanji: '伺います', kana: 'うかがいます', romaji: 'ukagaimasu', meaning: '拜访；请教（謙譲語）', conjugations: { dictionary: '伺う', masu: 'うかがいます', te: '伺って', nai: '伺わない', ta: '伺った' }, sentences: [{ ja: '午後先生のお宅へ伺います。', zh: '下午拜访老师家。' }] },
    { id: 'L50-W9', category: 'Verbs', grammarType: 'Group I', kanji: 'お目にかかります', kana: 'おめにかかります', romaji: 'ome ni kakarimasu', meaning: '见面（謙譲語）', conjugations: { dictionary: 'お目にかかる', masu: 'おめにかかります', te: 'お目にかかって', nai: 'お目にかからない', ta: 'お目にかかった' }, sentences: [{ ja: '社長にお目にかかりました。', zh: '见到了社长。' }] },
    { id: 'L50-W10', category: 'Verbs', grammarType: 'Group I', kanji: 'ございます', kana: 'ございます', romaji: 'gozaimasu', meaning: '有，是（丁重語）', conjugations: { dictionary: 'ござる', masu: 'ございます', te: 'ございまして', nai: 'ございません', ta: 'ございました' }, sentences: [{ ja: '資料はこちらにございます。', zh: '资料在这里。' }] },
    { id: 'L50-W11', category: 'Verbs', grammarType: 'Irregular', kanji: '緊張します', kana: 'きんちょうします', romaji: 'kinchou shimasu', meaning: '紧张', conjugations: { dictionary: '緊張する', masu: 'きんちょうします', te: '緊張して', nai: '緊張しない', ta: '緊張した' }, sentences: [{ ja: 'スピーチの前に緊張しました。', zh: '演讲前紧张了。' }] },
    { id: 'L50-W12', category: 'Verbs', grammarType: 'Irregular', kanji: '放送します', kana: 'ほうそうします', romaji: 'housou shimasu', meaning: '广播，播送', conjugations: { dictionary: '放送する', masu: 'ほうそうします', te: '放送して', nai: '放送しない', ta: '放送した' }, sentences: [{ ja: 'ニュースを放送します。', zh: '播送新闻。' }] },
    { id: 'L50-W13', category: 'Verbs', grammarType: 'Group I', kanji: '撮ります', kana: 'とります', romaji: 'torimasu', meaning: '拍摄', conjugations: { dictionary: '撮る', masu: 'とります', te: '撮って', nai: '撮らない', ta: '撮った' }, sentences: [{ ja: '記念写真を撮ります。', zh: '拍纪念照。' }] },
    { id: 'L50-W14', category: 'Nouns', kanji: '賞金', kana: 'しょうきん', romaji: 'shoukin', meaning: '奖金', sentences: [{ ja: '賞金をいただきました。', zh: '获得了奖金。' }] },
    { id: 'L50-W15', category: 'Nouns', kanji: 'きりん', kana: 'きりん', romaji: 'kirin', meaning: '长颈鹿', sentences: [{ ja: '動物園できりんを見ました。', zh: '在动物园看了长颈鹿。' }] },
    { id: 'L50-W16', category: 'Nouns', kanji: 'ころ', kana: 'ころ', romaji: 'koro', meaning: '时候', sentences: [{ ja: '子どものころ、よく泳ぎました。', zh: '小时候经常游泳。' }] },
    { id: 'L50-W17', category: 'Verbs', grammarType: 'Irregular', kanji: '協力します', kana: 'きょうりょくします', romaji: 'kyouryoku shimasu', meaning: '合作，协助', conjugations: { dictionary: '協力する', masu: 'きょうりょくします', te: '協力して', nai: '協力しない', ta: '協力した' }, sentences: [{ ja: '調査に協力します。', zh: '协助调查。' }] },
    { id: 'L50-W18', category: 'Verbs', grammarType: 'Irregular', kanji: '感謝します', kana: 'かんしゃします', romaji: 'kansha shimasu', meaning: '感谢', conjugations: { dictionary: '感謝する', masu: 'かんしゃします', te: '感謝して', nai: '感謝しない', ta: '感謝した' }, sentences: [{ ja: '皆様に心から感謝いたします。', zh: '向各位表示由衷感谢。' }] },
    { id: 'L50-W19', category: 'Nouns', kanji: 'お礼', kana: 'おれい', romaji: 'orei', meaning: '感谢，谢礼', sentences: [{ ja: 'お礼を申し上げます。', zh: '表达谢意。' }] },
    { id: 'L50-W20', category: 'Nouns', kanji: 'スピーチ', kana: 'スピーチ', romaji: 'supiichi', meaning: '演讲，致辞', sentences: [{ ja: '結婚式でスピーチをしました。', zh: '在婚礼上做了致辞。' }] },
    { id: 'L50-W21', category: 'Adverbs', kanji: '心から', kana: 'こころから', romaji: 'kokoro kara', meaning: '从心里，衷心', sentences: [{ ja: '心から感謝いたします。', zh: '衷心感谢。' }] }
  ]
};
