...
export const STATIC_LESSONS: Record<number, VocabularyItem[]> = {
 ...
 5: [
  ...
  29: [
    ...
    { id: 'L29-W18', category: 'Verbs', grammarType: 'Group II', kanji: '破れます', kana: 'やぶれます', romaji: 'yaburemasu', meaning: '破；撕破', conjugations: { dictionary: '破れる', masu: '破れます', te: '破れて', nai: '破れない', ta: '破れた' }, sentences: [{ ja: '袋が破れてしまいました。', zh: '袋子破了。' }] },
  ...
  41: [
    ...
    { id: 'L41-W52', category: 'Verbs', grammarType: 'Group I', kanji: '虐めます', kana: 'いじめます', romaji: 'ijimemasu', meaning: '欺负', conjugations: { dictionary: '虐める', masu: 'いじめます', te: '虐めて', nai: '虐めない', ta: '虐めた' }, sentences: [{ ja: '動物を虐めてはいけません。', zh: '不可以欺负动物。' }] },
